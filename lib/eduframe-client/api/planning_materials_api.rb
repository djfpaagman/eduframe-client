...
module Eduframe
  class PlanningMaterialsApi
    ...
    def get_planning_materials(opts = {})
      data, _status_code, _headers = get_planning_materials_with_http_info(opts)
      data
    end
    ...
    def get_planning_materials_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningMaterialsApi.get_planning_materials ...'
      end
      ...
      # resource path
      local_var_path = '/planning/materials'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningMaterialsApi#get_planning_materials\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
