...
module Eduframe
  class ProgramEnrollmentsApi
    ...
    # @option opts [String] :student_id Filter results on student_id
    # @option opts [String] :edition_id Filter results on edition_id
    # @option opts [String] :state Filter results on state
    ...
    # @return [Array<ProgramEnrollment>]
    def get_program_enrollments(opts = {})
      data, _status_code, _headers = get_program_enrollments_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :state Filter results on state
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<ProgramEnrollment>, Fixnum, Hash)>] Array<ProgramEnrollment> data, response status code and response headers
    def get_program_enrollments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEnrollmentsApi.get_program_enrollments ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['student', 'order.account', 'order', 'edition.program', 'edition', 'blocks.course', 'blocks.course_enrollment.grade', 'blocks.course_enrollment', 'blocks', 'graduation'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of student, order.account, order, edition.program, edition, blocks.course, blocks.course_enrollment.grade, blocks.course_enrollment, blocks, graduation'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['orders.number', 'orders', 'users.first_name', 'users', 'accounts.name', 'accounts'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of orders.number, orders, users.first_name, users, accounts.name, accounts'
      end
      # resource path
      local_var_path = '/program/enrollments'

      # query parameters
      query_params = {}
      query_params[:'include'] = @api_client.build_collection_param(opts[:'include'], :csv) if !opts[:'include'].nil?
      query_params[:'student_id'] = opts[:'student_id'] if !opts[:'student_id'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<ProgramEnrollment>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEnrollmentsApi#get_program_enrollments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_program_enrollments_id(id, opts = {})
      data, _status_code, _headers = get_program_enrollments_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(ProgramEnrollment, Fixnum, Hash)>] ProgramEnrollment data, response status code and response headers
    def get_program_enrollments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEnrollmentsApi.get_program_enrollments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramEnrollmentsApi.get_program_enrollments_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['student', 'order.account', 'order', 'edition.program', 'edition', 'blocks.course', 'blocks.course_enrollment.grade', 'blocks.course_enrollment', 'blocks', 'graduation'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of student, order.account, order, edition.program, edition, blocks.course, blocks.course_enrollment.grade, blocks.course_enrollment, blocks, graduation'
      end
      # resource path
      local_var_path = '/program/enrollments/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProgramEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEnrollmentsApi#get_program_enrollments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [ProgramEnrollment]
    def put_program_enrollments_id_cancel(id, opts = {})
      data, _status_code, _headers = put_program_enrollments_id_cancel_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(ProgramEnrollment, Fixnum, Hash)>] ProgramEnrollment data, response status code and response headers
    def put_program_enrollments_id_cancel_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEnrollmentsApi.put_program_enrollments_id_cancel ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramEnrollmentsApi.put_program_enrollments_id_cancel"
      end
      # resource path
      local_var_path = '/program/enrollments/{id}/cancel'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProgramEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEnrollmentsApi#put_program_enrollments_id_cancel\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
