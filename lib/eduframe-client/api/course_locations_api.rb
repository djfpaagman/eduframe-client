...
module Eduframe
  class CourseLocationsApi
    ...
    def delete_course_locations_id(id, opts = {})
      data, _status_code, _headers = delete_course_locations_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CourseLocation, Fixnum, Hash)>] CourseLocation data, response status code and response headers
    def delete_course_locations_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseLocationsApi.delete_course_locations_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CourseLocationsApi.delete_course_locations_id"
      end
      # resource path
      local_var_path = '/course_locations/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'CourseLocation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseLocationsApi#delete_course_locations_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<CourseLocation>]
    def get_course_locations(opts = {})
      data, _status_code, _headers = get_course_locations_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :id Filter results on id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<CourseLocation>, Fixnum, Hash)>] Array<CourseLocation> data, response status code and response headers
    def get_course_locations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseLocationsApi.get_course_locations ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['address', 'meeting_locations.address', 'meeting_locations'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of address, meeting_locations.address, meeting_locations'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['name'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of name'
      end
      # resource path
      local_var_path = '/course_locations'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<CourseLocation>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseLocationsApi#get_course_locations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [CourseLocation]
    def get_course_locations_id(id, opts = {})
      data, _status_code, _headers = get_course_locations_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(CourseLocation, Fixnum, Hash)>] CourseLocation data, response status code and response headers
    def get_course_locations_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseLocationsApi.get_course_locations_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CourseLocationsApi.get_course_locations_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['address', 'meeting_locations.address', 'meeting_locations'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of address, meeting_locations.address, meeting_locations'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'CourseLocation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseLocationsApi#get_course_locations_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [CourseLocation]
    def post_course_locations(opts = {})
      data, _status_code, _headers = post_course_locations_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(CourseLocation, Fixnum, Hash)>] CourseLocation data, response status code and response headers
    def post_course_locations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseLocationsApi.post_course_locations ...'
      end
      # resource path
      local_var_path = '/course_locations'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CourseLocation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseLocationsApi#post_course_locations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [CourseLocation]
    def put_course_locations_id(id, opts = {})
      data, _status_code, _headers = put_course_locations_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(CourseLocation, Fixnum, Hash)>] CourseLocation data, response status code and response headers
    def put_course_locations_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseLocationsApi.put_course_locations_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CourseLocationsApi.put_course_locations_id"
      end
      # resource path
      local_var_path = '/course_locations/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CourseLocation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseLocationsApi#put_course_locations_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
