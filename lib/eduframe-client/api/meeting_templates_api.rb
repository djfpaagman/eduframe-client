...
module Eduframe
  class MeetingTemplatesApi
    ...
    def delete_meeting_templates_id(id, opts = {})
      data, _status_code, _headers = delete_meeting_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(MeetingTemplate, Fixnum, Hash)>] MeetingTemplate data, response status code and response headers
    def delete_meeting_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingTemplatesApi.delete_meeting_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MeetingTemplatesApi.delete_meeting_templates_id"
      end
      # resource path
      local_var_path = '/meeting_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'MeetingTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingTemplatesApi#delete_meeting_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<MeetingTemplate>]
    def get_meeting_templates(opts = {})
      data, _status_code, _headers = get_meeting_templates_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :course_id Filter results on course_id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<MeetingTemplate>, Fixnum, Hash)>] Array<MeetingTemplate> data, response status code and response headers
    def get_meeting_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingTemplatesApi.get_meeting_templates ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['teachers', 'materials', 'planning_meeting_locations', 'planning_materials.material', 'planning_materials', 'meeting_location.course_location', 'meeting_location', 'planning_attendees.teacher', 'planning_attendees.teacher_role', 'planning_attendees', 'planning_event_templates.planning_meeting_locations', 'planning_event_templates.materials', 'planning_event_templates.planning_attendees.teacher', 'planning_event_templates.planning_attendees.teacher_role', 'planning_event_templates.planning_attendees', 'planning_event_templates'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of teachers, materials, planning_meeting_locations, planning_materials.material, planning_materials, meeting_location.course_location, meeting_location, planning_attendees.teacher, planning_attendees.teacher_role, planning_attendees, planning_event_templates.planning_meeting_locations, planning_event_templates.materials, planning_event_templates.planning_attendees.teacher, planning_event_templates.planning_attendees.teacher_role, planning_event_templates.planning_attendees, planning_event_templates'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['offset_in_days', 'offset_anchor', 'start_time'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of offset_in_days, offset_anchor, start_time'
      end
      # resource path
      local_var_path = '/meeting_templates'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<MeetingTemplate>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingTemplatesApi#get_meeting_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [MeetingTemplate]
    def get_meeting_templates_id(id, opts = {})
      data, _status_code, _headers = get_meeting_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(MeetingTemplate, Fixnum, Hash)>] MeetingTemplate data, response status code and response headers
    def get_meeting_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingTemplatesApi.get_meeting_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MeetingTemplatesApi.get_meeting_templates_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['teachers', 'materials', 'planning_meeting_locations', 'planning_materials.material', 'planning_materials', 'meeting_location.course_location', 'meeting_location', 'planning_attendees.teacher', 'planning_attendees.teacher_role', 'planning_attendees', 'planning_event_templates.planning_meeting_locations', 'planning_event_templates.materials', 'planning_event_templates.planning_attendees.teacher', 'planning_event_templates.planning_attendees.teacher_role', 'planning_event_templates.planning_attendees', 'planning_event_templates'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of teachers, materials, planning_meeting_locations, planning_materials.material, planning_materials, meeting_location.course_location, meeting_location, planning_attendees.teacher, planning_attendees.teacher_role, planning_attendees, planning_event_templates.planning_meeting_locations, planning_event_templates.materials, planning_event_templates.planning_attendees.teacher, planning_event_templates.planning_attendees.teacher_role, planning_event_templates.planning_attendees, planning_event_templates'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'MeetingTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingTemplatesApi#get_meeting_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [MeetingTemplate]
    def post_meeting_templates(opts = {})
      data, _status_code, _headers = post_meeting_templates_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(MeetingTemplate, Fixnum, Hash)>] MeetingTemplate data, response status code and response headers
    def post_meeting_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingTemplatesApi.post_meeting_templates ...'
      end
      # resource path
      local_var_path = '/meeting_templates'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'MeetingTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingTemplatesApi#post_meeting_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [MeetingTemplate]
    def put_meeting_templates_id(id, opts = {})
      data, _status_code, _headers = put_meeting_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(MeetingTemplate, Fixnum, Hash)>] MeetingTemplate data, response status code and response headers
    def put_meeting_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingTemplatesApi.put_meeting_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MeetingTemplatesApi.put_meeting_templates_id"
      end
      # resource path
      local_var_path = '/meeting_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'MeetingTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingTemplatesApi#put_meeting_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
