...
module Eduframe
  class GradesApi
    ...
    # @return [Grade]
    def get_grades_id(id, opts = {})
      data, _status_code, _headers = get_grades_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Grade, Fixnum, Hash)>] Grade data, response status code and response headers
    def get_grades_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradesApi.get_grades_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GradesApi.get_grades_id"
      end
      # resource path
      local_var_path = '/grades/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Grade')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradesApi#get_grades_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Grade]
    def post_grades(opts = {})
      data, _status_code, _headers = post_grades_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Grade, Fixnum, Hash)>] Grade data, response status code and response headers
    def post_grades_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradesApi.post_grades ...'
      end
      # resource path
      local_var_path = '/grades'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Grade')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradesApi#post_grades\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a grade
    ...
    # @option opts [Body] :body 
    # @return [Grade]
    def put_grades_id(id, opts = {})
      data, _status_code, _headers = put_grades_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Grade, Fixnum, Hash)>] Grade data, response status code and response headers
    def put_grades_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradesApi.put_grades_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GradesApi.put_grades_id"
      end
      # resource path
      local_var_path = '/grades/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Grade')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradesApi#put_grades_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
