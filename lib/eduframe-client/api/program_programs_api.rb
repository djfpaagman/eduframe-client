...
module Eduframe
  class ProgramProgramsApi
    ...
    # @return [Program]
    def delete_program_programs_id(id, opts = {})
      data, _status_code, _headers = delete_program_programs_id_with_http_info(id, opts)
      data
    end
    ...
    def delete_program_programs_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramProgramsApi.delete_program_programs_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramProgramsApi.delete_program_programs_id"
      end
      # resource path
      local_var_path = '/program/programs/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Program')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramProgramsApi#delete_program_programs_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_program_programs(opts = {})
      data, _status_code, _headers = get_program_programs_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :search Filter results on search
    # @option opts [Array<String>] :id Filter results on id
    # @return [Array<(Array<Program>, Fixnum, Hash)>] Array<Program> data, response status code and response headers
    def get_program_programs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramProgramsApi.get_program_programs ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'category', 'avatar_attachment', 'custom', 'signup_answers.signup_question', 'signup_answers', 'course_tab_contents.course_tab', 'course_tab_contents'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, category, avatar_attachment, custom, signup_answers.signup_question, signup_answers, course_tab_contents.course_tab, course_tab_contents'
      end
      # resource path
      local_var_path = '/program/programs'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<Program>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramProgramsApi#get_program_programs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get a program
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Program]
    def get_program_programs_id(id, opts = {})
      data, _status_code, _headers = get_program_programs_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Program, Fixnum, Hash)>] Program data, response status code and response headers
    def get_program_programs_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramProgramsApi.get_program_programs_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramProgramsApi.get_program_programs_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'category', 'avatar_attachment', 'custom', 'signup_answers.signup_question', 'signup_answers', 'course_tab_contents.course_tab', 'course_tab_contents'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, category, avatar_attachment, custom, signup_answers.signup_question, signup_answers, course_tab_contents.course_tab, course_tab_contents'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Program')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramProgramsApi#get_program_programs_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a program
    ...
    # @option opts [Body] :body 
    # @return [Program]
    def post_program_programs(opts = {})
      data, _status_code, _headers = post_program_programs_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Program, Fixnum, Hash)>] Program data, response status code and response headers
    def post_program_programs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramProgramsApi.post_program_programs ...'
      end
      # resource path
      local_var_path = '/program/programs'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Program')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramProgramsApi#post_program_programs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a program
    ...
    # @option opts [Body] :body 
    # @return [Program]
    def put_program_programs_id(id, opts = {})
      data, _status_code, _headers = put_program_programs_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Program, Fixnum, Hash)>] Program data, response status code and response headers
    def put_program_programs_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramProgramsApi.put_program_programs_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramProgramsApi.put_program_programs_id"
      end
      # resource path
      local_var_path = '/program/programs/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Program')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramProgramsApi#put_program_programs_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
