...
module Eduframe
  class TasksApi
    ...
    # @return [Task]
    def delete_tasks_id(id, opts = {})
      data, _status_code, _headers = delete_tasks_id_with_http_info(id, opts)
      data
    end
    ...
    def delete_tasks_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.delete_tasks_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TasksApi.delete_tasks_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Task')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#delete_tasks_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :due_date Filter results on due_date
    # @option opts [String] :completed_at Filter results on completed_at
    # @option opts [String] :assignee_id Filter results on assignee_id
    # @option opts [String] :creator_id Filter results on creator_id
    # @option opts [String] :completed_by_id Filter results on completed_by_id
    # @option opts [String] :subject_type Filter results on subject_type
    # @option opts [String] :subject_id Filter results on subject_id
    # @return [Array<Task>]
    def get_tasks(opts = {})
    ...
    def get_tasks_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['creator', 'completed_by', 'assignee'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of creator, completed_by, assignee'
      end
      # resource path
      ...
      query_params[:'completed_at'] = opts[:'completed_at'] if !opts[:'completed_at'].nil?
      ...
      query_params[:'completed_by_id'] = opts[:'completed_by_id'] if !opts[:'completed_by_id'].nil?
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Task]
    def get_tasks_id(id, opts = {})
      data, _status_code, _headers = get_tasks_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Task, Fixnum, Hash)>] Task data, response status code and response headers
    def get_tasks_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.get_tasks_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TasksApi.get_tasks_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['creator', 'completed_by', 'assignee'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of creator, completed_by, assignee'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Task')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#get_tasks_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a task.
    ...
    # @return [Task]
    def post_tasks(opts = {})
      data, _status_code, _headers = post_tasks_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Task, Fixnum, Hash)>] Task data, response status code and response headers
    def post_tasks_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.post_tasks ...'
      end
      # resource path
      local_var_path = '/tasks'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Task')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#post_tasks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a task.
    ...
    # @option opts [Body] :body 
    # @return [Task]
    def put_tasks_id(id, opts = {})
      data, _status_code, _headers = put_tasks_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Task, Fixnum, Hash)>] Task data, response status code and response headers
    def put_tasks_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.put_tasks_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TasksApi.put_tasks_id"
      end
      # resource path
      local_var_path = '/tasks/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Task')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#put_tasks_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
