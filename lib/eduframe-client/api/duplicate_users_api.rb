...
module Eduframe
  class DuplicateUsersApi
    ...
    # @option opts [String] :unique Filter results on unique
    # @option opts [String] :dismissed Filter results on dismissed
    # @option opts [Array<String>] :user_id Filter results on user_id
    # @option opts [Array<String>] :include Include relations
    # @return [Array<DuplicateUser>]
    def get_duplicate_users(opts = {})
      data, _status_code, _headers = get_duplicate_users_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :user_id Filter results on user_id
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Array<DuplicateUser>, Fixnum, Hash)>] Array<DuplicateUser> data, response status code and response headers
    def get_duplicate_users_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DuplicateUsersApi.get_duplicate_users ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['user', 'duplicate_user'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of user, duplicate_user'
      end
      # resource path
      local_var_path = '/duplicate/users'

      # query parameters
      query_params = {}
      query_params[:'unique'] = opts[:'unique'] if !opts[:'unique'].nil?
      query_params[:'dismissed'] = opts[:'dismissed'] if !opts[:'dismissed'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<DuplicateUser>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuplicateUsersApi#get_duplicate_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def put_duplicate_users_id(id, opts = {})
      data, _status_code, _headers = put_duplicate_users_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(DuplicateUser, Fixnum, Hash)>] DuplicateUser data, response status code and response headers
    def put_duplicate_users_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DuplicateUsersApi.put_duplicate_users_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DuplicateUsersApi.put_duplicate_users_id"
      end
      # resource path
      local_var_path = '/duplicate/users/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DuplicateUser')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuplicateUsersApi#put_duplicate_users_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
