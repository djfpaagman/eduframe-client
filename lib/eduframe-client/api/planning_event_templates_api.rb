...
module Eduframe
  class PlanningEventTemplatesApi
    ...
    # @return [PlanningEventTemplate]
    def delete_planning_events_templates_id(id, opts = {})
      data, _status_code, _headers = delete_planning_events_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PlanningEventTemplate, Fixnum, Hash)>] PlanningEventTemplate data, response status code and response headers
    def delete_planning_events_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningEventTemplatesApi.delete_planning_events_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PlanningEventTemplatesApi.delete_planning_events_templates_id"
      end
      # resource path
      local_var_path = '/planning/events_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'PlanningEventTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningEventTemplatesApi#delete_planning_events_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<PlanningEventTemplate>]
    def get_planning_event_templates(opts = {})
      data, _status_code, _headers = get_planning_event_templates_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :start_before Filter results on start_before
    # @option opts [String] :end_after Filter results on end_after
    # @return [Array<(Array<PlanningEventTemplate>, Fixnum, Hash)>] Array<PlanningEventTemplate> data, response status code and response headers
    def get_planning_event_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningEventTemplatesApi.get_planning_event_templates ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['planning_meeting_locations', 'planning_attendees.teacher', 'planning_attendees.teacher_role', 'planning_attendees', 'planning_materials.material', 'planning_materials'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of planning_meeting_locations, planning_attendees.teacher, planning_attendees.teacher_role, planning_attendees, planning_materials.material, planning_materials'
      end
      # resource path
      local_var_path = '/planning/event_templates'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<PlanningEventTemplate>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningEventTemplatesApi#get_planning_event_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [PlanningEventTemplate]
    def get_planning_event_templates_id(id, opts = {})
      data, _status_code, _headers = get_planning_event_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(PlanningEventTemplate, Fixnum, Hash)>] PlanningEventTemplate data, response status code and response headers
    def get_planning_event_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningEventTemplatesApi.get_planning_event_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PlanningEventTemplatesApi.get_planning_event_templates_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['planning_meeting_locations', 'planning_attendees.teacher', 'planning_attendees.teacher_role', 'planning_attendees', 'planning_materials.material', 'planning_materials'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of planning_meeting_locations, planning_attendees.teacher, planning_attendees.teacher_role, planning_attendees, planning_materials.material, planning_materials'
      end
      # resource path
      local_var_path = '/planning/event_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PlanningEventTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningEventTemplatesApi#get_planning_event_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [PlanningEventTemplate]
    def post_planning_events_templates_id(id, opts = {})
      data, _status_code, _headers = post_planning_events_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(PlanningEventTemplate, Fixnum, Hash)>] PlanningEventTemplate data, response status code and response headers
    def post_planning_events_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningEventTemplatesApi.post_planning_events_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PlanningEventTemplatesApi.post_planning_events_templates_id"
      end
      # resource path
      local_var_path = '/planning/events_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PlanningEventTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningEventTemplatesApi#post_planning_events_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [PlanningEventTemplate]
    def put_planning_events_templates_id(id, opts = {})
      data, _status_code, _headers = put_planning_events_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(PlanningEventTemplate, Fixnum, Hash)>] PlanningEventTemplate data, response status code and response headers
    def put_planning_events_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlanningEventTemplatesApi.put_planning_events_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PlanningEventTemplatesApi.put_planning_events_templates_id"
      end
      # resource path
      local_var_path = '/planning/events_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'PlanningEventTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlanningEventTemplatesApi#put_planning_events_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
