...
module Eduframe
  class CertificateTemplatesApi
    ...
    # @return [CerfiticateTemplate]
    def delete_certificate_templates_id(id, opts = {})
      data, _status_code, _headers = delete_certificate_templates_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CerfiticateTemplate, Fixnum, Hash)>] CerfiticateTemplate data, response status code and response headers
    def delete_certificate_templates_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CertificateTemplatesApi.delete_certificate_templates_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificateTemplatesApi.delete_certificate_templates_id"
      end
      # resource path
      local_var_path = '/certificate_templates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'CerfiticateTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CertificateTemplatesApi#delete_certificate_templates_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<CerfiticateTemplate>]
    def get_certificate_templates(opts = {})
      data, _status_code, _headers = get_certificate_templates_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<CerfiticateTemplate>, Fixnum, Hash)>] Array<CerfiticateTemplate> data, response status code and response headers
    def get_certificate_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CertificateTemplatesApi.get_certificate_templates ...'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['name', 'validity'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of name, validity'
      end
      # resource path
      local_var_path = '/certificate_templates'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<CerfiticateTemplate>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CertificateTemplatesApi#get_certificate_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CerfiticateTemplate]
    def put_certificate_templates_id_duplicate(id, opts = {})
      data, _status_code, _headers = put_certificate_templates_id_duplicate_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CerfiticateTemplate, Fixnum, Hash)>] CerfiticateTemplate data, response status code and response headers
    def put_certificate_templates_id_duplicate_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CertificateTemplatesApi.put_certificate_templates_id_duplicate ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificateTemplatesApi.put_certificate_templates_id_duplicate"
      end
      # resource path
      local_var_path = '/certificate_templates/{id}/duplicate'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CerfiticateTemplate')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CertificateTemplatesApi#put_certificate_templates_id_duplicate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
