  ...
  class AuthorizationRolesApi
    ...
    def get_authorization_roles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthorizationRolesApi.get_authorization_roles ...'
      end
      # resource path
      local_var_path = '/authorization/roles'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationRolesApi#get_authorization_roles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
