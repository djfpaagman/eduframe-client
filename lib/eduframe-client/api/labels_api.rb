...
module Eduframe
  class LabelsApi
    ...
    # @option opts [String] :name Filter results on name
    # @option opts [String] :model_type Filter results on model_type
    ...
    def get_labels_with_http_info(opts = {})
      ...
      query_params[:'model_type'] = opts[:'model_type'] if !opts[:'model_type'].nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [Label]
    def get_labels_id(id, opts = {})
      data, _status_code, _headers = get_labels_id_with_http_info(id, opts)
      data
    end
    ...
    def get_labels_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LabelsApi.get_labels_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LabelsApi.get_labels_id"
      end
      # resource path
