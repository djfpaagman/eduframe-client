...
module Eduframe
  class MaterialGroupsApi
    ...
    def delete_material_groups_id(id, opts = {})
      data, _status_code, _headers = delete_material_groups_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(MaterialGroup, Fixnum, Hash)>] MaterialGroup data, response status code and response headers
    def delete_material_groups_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MaterialGroupsApi.delete_material_groups_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MaterialGroupsApi.delete_material_groups_id"
      end
      # resource path
      local_var_path = '/material_groups/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'MaterialGroup')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MaterialGroupsApi#delete_material_groups_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<MaterialGroup>]
    def get_material_groups(opts = {})
      data, _status_code, _headers = get_material_groups_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :id Filter results on id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<MaterialGroup>, Fixnum, Hash)>] Array<MaterialGroup> data, response status code and response headers
    def get_material_groups_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MaterialGroupsApi.get_material_groups ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['materials'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of materials'
      end
      ...
      # resource path
      local_var_path = '/material_groups'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<MaterialGroup>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MaterialGroupsApi#get_material_groups\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [MaterialGroup]
    def get_material_groups_id(id, opts = {})
      data, _status_code, _headers = get_material_groups_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(MaterialGroup, Fixnum, Hash)>] MaterialGroup data, response status code and response headers
    def get_material_groups_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MaterialGroupsApi.get_material_groups_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MaterialGroupsApi.get_material_groups_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['materials'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of materials'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'MaterialGroup')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MaterialGroupsApi#get_material_groups_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [MaterialGroup]
    def post_material_groups(opts = {})
      data, _status_code, _headers = post_material_groups_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(MaterialGroup, Fixnum, Hash)>] MaterialGroup data, response status code and response headers
    def post_material_groups_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MaterialGroupsApi.post_material_groups ...'
      end
      # resource path
      local_var_path = '/material_groups'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'MaterialGroup')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MaterialGroupsApi#post_material_groups\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [MaterialGroup]
    def put_material_groups_id(id, opts = {})
      data, _status_code, _headers = put_material_groups_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(MaterialGroup, Fixnum, Hash)>] MaterialGroup data, response status code and response headers
    def put_material_groups_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MaterialGroupsApi.put_material_groups_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MaterialGroupsApi.put_material_groups_id"
      end
      # resource path
      local_var_path = '/material_groups/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'MaterialGroup')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MaterialGroupsApi#put_material_groups_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
