...
module Eduframe
  class CoursesApi
    ...
    # @option opts [String] :published Filter results on published
    # @option opts [String] :search Filter results on search
    # @option opts [Array<String>] :id Filter results on id
    # @option opts [Array<String>] :category_id Filter results on category_id
    ...
    def get_courses_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'custom', 'credit_definitions.type.category', 'credit_definitions.type', 'credit_definitions', 'course_tab_contents.course_tab', 'course_tab_contents'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, custom, credit_definitions.type.category, credit_definitions.type, credit_definitions, course_tab_contents.course_tab, course_tab_contents'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['id', 'name', 'code', 'position'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of id, name, code, position'
      end
      # resource path
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Course]
    def get_courses_id(id, opts = {})
      data, _status_code, _headers = get_courses_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Course, Fixnum, Hash)>] Course data, response status code and response headers
    def get_courses_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoursesApi.get_courses_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CoursesApi.get_courses_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'custom', 'credit_definitions.type.category', 'credit_definitions.type', 'credit_definitions', 'course_tab_contents.course_tab', 'course_tab_contents'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, custom, credit_definitions.type.category, credit_definitions.type, credit_definitions, course_tab_contents.course_tab, course_tab_contents'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Course')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoursesApi#get_courses_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a course.
    ...
    # @return [Course]
    def post_courses(opts = {})
      data, _status_code, _headers = post_courses_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Course, Fixnum, Hash)>] Course data, response status code and response headers
    def post_courses_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoursesApi.post_courses ...'
      end
      # resource path
      local_var_path = '/courses'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Course')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoursesApi#post_courses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a course.
    ...
    # @option opts [Body] :body 
    # @return [Course]
    def put_courses_id(id, opts = {})
      data, _status_code, _headers = put_courses_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Course, Fixnum, Hash)>] Course data, response status code and response headers
    def put_courses_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoursesApi.put_courses_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CoursesApi.put_courses_id"
      end
      # resource path
      local_var_path = '/courses/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Course')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoursesApi#put_courses_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
