...
module Eduframe
  class SignupQuestionsApi
    ...
    # @option opts [String] :for_user Filter results on for_user
    # @option opts [String] :for_account Filter results on for_account
    # @option opts [String] :for_type Filter results on for_type
    # @option opts [String] :visibility Filter results on visibility
    # @option opts [String] :use_as_duplicate_indicator Filter results on use_as_duplicate_indicator
    # @return [Array<SignupQuestion>]
    def get_signup_questions(opts = {})
      data, _status_code, _headers = get_signup_questions_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :visibility Filter results on visibility
    # @option opts [String] :use_as_duplicate_indicator Filter results on use_as_duplicate_indicator
    # @return [Array<(Array<SignupQuestion>, Fixnum, Hash)>] Array<SignupQuestion> data, response status code and response headers
    def get_signup_questions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignupQuestionsApi.get_signup_questions ...'
      end
      # resource path
      local_var_path = '/signup_questions'

      # query parameters
      query_params = {}
      query_params[:'for_user'] = opts[:'for_user'] if !opts[:'for_user'].nil?
      query_params[:'for_account'] = opts[:'for_account'] if !opts[:'for_account'].nil?
      query_params[:'for_type'] = opts[:'for_type'] if !opts[:'for_type'].nil?
      query_params[:'visibility'] = opts[:'visibility'] if !opts[:'visibility'].nil?
      query_params[:'use_as_duplicate_indicator'] = opts[:'use_as_duplicate_indicator'] if !opts[:'use_as_duplicate_indicator'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<SignupQuestion>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignupQuestionsApi#get_signup_questions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
