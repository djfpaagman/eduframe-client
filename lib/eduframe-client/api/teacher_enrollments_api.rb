...
module Eduframe
  class TeacherEnrollmentsApi
    ...
    def delete_teacher_enrollments_id(id, opts = {})
      data, _status_code, _headers = delete_teacher_enrollments_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeacherEnrollment, Fixnum, Hash)>] TeacherEnrollment data, response status code and response headers
    def delete_teacher_enrollments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.delete_teacher_enrollments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeacherEnrollmentsApi.delete_teacher_enrollments_id"
      end
      # resource path
      local_var_path = '/teacher_enrollments/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'TeacherEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#delete_teacher_enrollments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<TeacherEnrollment>]
    def get_planned_courses_planned_course_id_teacher_enrollments(planned_course_id, opts = {})
      data, _status_code, _headers = get_planned_courses_planned_course_id_teacher_enrollments_with_http_info(planned_course_id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<TeacherEnrollment>, Fixnum, Hash)>] Array<TeacherEnrollment> data, response status code and response headers
    def get_planned_courses_planned_course_id_teacher_enrollments_with_http_info(planned_course_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.get_planned_courses_planned_course_id_teacher_enrollments ...'
      end
      # verify the required parameter 'planned_course_id' is set
      if @api_client.config.client_side_validation && planned_course_id.nil?
        fail ArgumentError, "Missing the required parameter 'planned_course_id' when calling TeacherEnrollmentsApi.get_planned_courses_planned_course_id_teacher_enrollments"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['teacher', 'teacher_role'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of teacher, teacher_role'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['teacher_name', 'role_name'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of teacher_name, role_name'
      end
      # resource path
      local_var_path = '/planned_courses/{planned_course_id}/teacher_enrollments'.sub('{' + 'planned_course_id' + '}', planned_course_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<TeacherEnrollment>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#get_planned_courses_planned_course_id_teacher_enrollments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<TeacherEnrollment>]
    def get_teacher_enrollments(planned_course_id, opts = {})
      data, _status_code, _headers = get_teacher_enrollments_with_http_info(planned_course_id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<TeacherEnrollment>, Fixnum, Hash)>] Array<TeacherEnrollment> data, response status code and response headers
    def get_teacher_enrollments_with_http_info(planned_course_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.get_teacher_enrollments ...'
      end
      # verify the required parameter 'planned_course_id' is set
      if @api_client.config.client_side_validation && planned_course_id.nil?
        fail ArgumentError, "Missing the required parameter 'planned_course_id' when calling TeacherEnrollmentsApi.get_teacher_enrollments"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['teacher', 'teacher_role'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of teacher, teacher_role'
      end
      ...
      # resource path
      local_var_path = '/teacher_enrollments'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<TeacherEnrollment>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#get_teacher_enrollments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [TeacherEnrollment]
    def post_planned_courses_planned_course_id_teacher_enrollments(planned_course_id, opts = {})
      data, _status_code, _headers = post_planned_courses_planned_course_id_teacher_enrollments_with_http_info(planned_course_id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(TeacherEnrollment, Fixnum, Hash)>] TeacherEnrollment data, response status code and response headers
    def post_planned_courses_planned_course_id_teacher_enrollments_with_http_info(planned_course_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.post_planned_courses_planned_course_id_teacher_enrollments ...'
      end
      # verify the required parameter 'planned_course_id' is set
      if @api_client.config.client_side_validation && planned_course_id.nil?
        fail ArgumentError, "Missing the required parameter 'planned_course_id' when calling TeacherEnrollmentsApi.post_planned_courses_planned_course_id_teacher_enrollments"
      end
      # resource path
      local_var_path = '/planned_courses/{planned_course_id}/teacher_enrollments'.sub('{' + 'planned_course_id' + '}', planned_course_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'TeacherEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#post_planned_courses_planned_course_id_teacher_enrollments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [TeacherEnrollment]
    def post_teacher_enrollments(opts = {})
      data, _status_code, _headers = post_teacher_enrollments_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(TeacherEnrollment, Fixnum, Hash)>] TeacherEnrollment data, response status code and response headers
    def post_teacher_enrollments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.post_teacher_enrollments ...'
      end
      # resource path
      local_var_path = '/teacher_enrollments'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'TeacherEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#post_teacher_enrollments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [TeacherEnrollment]
    def put_teacher_enrollments_id(id, opts = {})
      data, _status_code, _headers = put_teacher_enrollments_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(TeacherEnrollment, Fixnum, Hash)>] TeacherEnrollment data, response status code and response headers
    def put_teacher_enrollments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherEnrollmentsApi.put_teacher_enrollments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeacherEnrollmentsApi.put_teacher_enrollments_id"
      end
      # resource path
      local_var_path = '/teacher_enrollments/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'TeacherEnrollment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherEnrollmentsApi#put_teacher_enrollments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
