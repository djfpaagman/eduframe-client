...
module Eduframe
  class LeadsApi
    ...
    # @return [Lead]
    def delete_leads_id(id, opts = {})
      data, _status_code, _headers = delete_leads_id_with_http_info(id, opts)
      data
    end
    ...
    def delete_leads_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeadsApi.delete_leads_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LeadsApi.delete_leads_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Lead')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LeadsApi#delete_leads_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Array<String>] :administrator_id Filter results on administrator_id
    # @option opts [Array<String>] :label_id Filter results on label_id
    # @option opts [Array<String>] :user_id Filter results on user_id
    # @option opts [Array<String>] :account_id Filter results on account_id
    ...
    # @option opts [Array<String>] :account_id Filter results on account_id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<Lead>, Fixnum, Hash)>] Array<Lead> data, response status code and response headers
    def get_leads_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeadsApi.get_leads ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'address', 'account', 'user', 'courses', 'administrator', 'attachments.file_attachment.blob', 'attachments.file_attachment', 'attachments', 'courses_leads.course', 'courses_leads.planned_course.course_location', 'courses_leads.planned_course.course_variant', 'courses_leads.planned_course', 'courses_leads'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, address, account, user, courses, administrator, attachments.file_attachment.blob, attachments.file_attachment, attachments, courses_leads.course, courses_leads.planned_course.course_location, courses_leads.planned_course.course_variant, courses_leads.planned_course, courses_leads'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['updated_at', 'status', 'title'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of updated_at, status, title'
      end
      # resource path
      ...
      query_params[:'administrator_id'] = @api_client.build_collection_param(opts[:'administrator_id'], :csv) if !opts[:'administrator_id'].nil?
      query_params[:'label_id'] = @api_client.build_collection_param(opts[:'label_id'], :csv) if !opts[:'label_id'].nil?
      query_params[:'user_id'] = @api_client.build_collection_param(opts[:'user_id'], :csv) if !opts[:'user_id'].nil?
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Lead]
    def get_leads_id(id, opts = {})
      data, _status_code, _headers = get_leads_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Lead, Fixnum, Hash)>] Lead data, response status code and response headers
    def get_leads_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeadsApi.get_leads_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LeadsApi.get_leads_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'address', 'account', 'user', 'courses', 'administrator', 'attachments.file_attachment.blob', 'attachments.file_attachment', 'attachments', 'courses_leads.course', 'courses_leads.planned_course.course_location', 'courses_leads.planned_course.course_variant', 'courses_leads.planned_course', 'courses_leads'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, address, account, user, courses, administrator, attachments.file_attachment.blob, attachments.file_attachment, attachments, courses_leads.course, courses_leads.planned_course.course_location, courses_leads.planned_course.course_variant, courses_leads.planned_course, courses_leads'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Lead')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LeadsApi#get_leads_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a lead.
    ...
    # @return [Error]
    def post_leads(opts = {})
      data, _status_code, _headers = post_leads_with_http_info(opts)
      data
    end
    ...
    def post_leads_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeadsApi.post_leads ...'
      end
      # resource path
      local_var_path = '/leads'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LeadsApi#post_leads\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update an lead.
    ...
    # @option opts [Body] :body 
    # @return [Lead]
    def put_leads_id(id, opts = {})
      data, _status_code, _headers = put_leads_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Lead, Fixnum, Hash)>] Lead data, response status code and response headers
    def put_leads_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeadsApi.put_leads_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LeadsApi.put_leads_id"
      end
      # resource path
      local_var_path = '/leads/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Lead')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LeadsApi#put_leads_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
