...
module Eduframe
  class DirectUploadsApi
    ...
    # @return [nil]
    def post_direct_uploads(opts = {})
      post_direct_uploads_with_http_info(opts)
      nil
    end
    ...
    def post_direct_uploads_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DirectUploadsApi.post_direct_uploads ...'
      end
      # resource path
      local_var_path = '/direct_uploads'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DirectUploadsApi#post_direct_uploads\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
