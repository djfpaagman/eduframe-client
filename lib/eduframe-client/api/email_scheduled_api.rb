...
module Eduframe
  class EmailScheduledApi
    ...
    def delete_email_scheduled_id(id, opts = {})
      data, _status_code, _headers = delete_email_scheduled_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ScheduledEmail, Fixnum, Hash)>] ScheduledEmail data, response status code and response headers
    def delete_email_scheduled_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EmailScheduledApi.delete_email_scheduled_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EmailScheduledApi.delete_email_scheduled_id"
      end
      # resource path
      local_var_path = '/email/scheduled/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'ScheduledEmail')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EmailScheduledApi#delete_email_scheduled_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ScheduledEmail]
    def put_email_scheduled_id_deliver(id, opts = {})
      data, _status_code, _headers = put_email_scheduled_id_deliver_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ScheduledEmail, Fixnum, Hash)>] ScheduledEmail data, response status code and response headers
    def put_email_scheduled_id_deliver_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EmailScheduledApi.put_email_scheduled_id_deliver ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EmailScheduledApi.put_email_scheduled_id_deliver"
      end
      # resource path
      local_var_path = '/email/scheduled/{id}/deliver'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ScheduledEmail')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EmailScheduledApi#put_email_scheduled_id_deliver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
