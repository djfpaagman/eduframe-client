...
module Eduframe
  class PaymentsApi
    ...
    # @return [Payment]
    def delete_invoices_invoice_id_payments_id(id, invoice_id, opts = {})
      data, _status_code, _headers = delete_invoices_invoice_id_payments_id_with_http_info(id, invoice_id, opts)
      data
    end
    ...
    def delete_invoices_invoice_id_payments_id_with_http_info(id, invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.delete_invoices_invoice_id_payments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.delete_invoices_invoice_id_payments_id"
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling PaymentsApi.delete_invoices_invoice_id_payments_id"
      end
      # resource path
      local_var_path = '/invoices/{invoice_id}/payments/{id}'.sub('{' + 'id' + '}', id.to_s).sub('{' + 'invoice_id' + '}', invoice_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Payment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#delete_invoices_invoice_id_payments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get all payment records of an invoice
    # 
    # @param invoice_id Filter results on invoice_id
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include Include relations
    # @option opts [String] :status Filter results on status
    # @return [Array<Payment>]
    def get_invoices_invoice_id_payments(invoice_id, opts = {})
      data, _status_code, _headers = get_invoices_invoice_id_payments_with_http_info(invoice_id, opts)
      data
    end
    ...
    def get_invoices_invoice_id_payments_with_http_info(invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.get_invoices_invoice_id_payments ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling PaymentsApi.get_invoices_invoice_id_payments"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['payment_method', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of payment_method, plugin_data.field, plugin_data'
      end
      # resource path
      local_var_path = '/invoices/{invoice_id}/payments'.sub('{' + 'invoice_id' + '}', invoice_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#get_invoices_invoice_id_payments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Payment]
    def get_payments_id(id, opts = {})
      data, _status_code, _headers = get_payments_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Payment, Fixnum, Hash)>] Payment data, response status code and response headers
    def get_payments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.get_payments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.get_payments_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['payment_method', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of payment_method, plugin_data.field, plugin_data'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Payment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#get_payments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a payment.
    ...
    # @return [Payment]
    def post_invoices_invoice_id_payments(invoice_id, opts = {})
      data, _status_code, _headers = post_invoices_invoice_id_payments_with_http_info(invoice_id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Payment, Fixnum, Hash)>] Payment data, response status code and response headers
    def post_invoices_invoice_id_payments_with_http_info(invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.post_invoices_invoice_id_payments ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling PaymentsApi.post_invoices_invoice_id_payments"
      end
      # resource path
      local_var_path = '/invoices/{invoice_id}/payments'.sub('{' + 'invoice_id' + '}', invoice_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Payment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#post_invoices_invoice_id_payments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
