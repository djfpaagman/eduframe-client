...
module Eduframe
  class PluginsDataApi
    ...
    # @return [PluginData]
    def delete_plugins_data_id(id, opts = {})
      data, _status_code, _headers = delete_plugins_data_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PluginData, Fixnum, Hash)>] PluginData data, response status code and response headers
    def delete_plugins_data_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsDataApi.delete_plugins_data_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PluginsDataApi.delete_plugins_data_id"
      end
      # resource path
      local_var_path = '/plugins/data/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'PluginData')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsDataApi#delete_plugins_data_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [PluginData]
    def post_plugins_data(opts = {})
      data, _status_code, _headers = post_plugins_data_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(PluginData, Fixnum, Hash)>] PluginData data, response status code and response headers
    def post_plugins_data_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsDataApi.post_plugins_data ...'
      end
      # resource path
      local_var_path = '/plugins/data'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PluginData')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsDataApi#post_plugins_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [PluginData]
    def put_plugins_data_id(id, opts = {})
      data, _status_code, _headers = put_plugins_data_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(PluginData, Fixnum, Hash)>] PluginData data, response status code and response headers
    def put_plugins_data_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsDataApi.put_plugins_data_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PluginsDataApi.put_plugins_data_id"
      end
      # resource path
      local_var_path = '/plugins/data/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'PluginData')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsDataApi#put_plugins_data_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
