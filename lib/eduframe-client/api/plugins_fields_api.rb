...
module Eduframe
  class PluginsFieldsApi
    ...
    # @return [PluginField]
    def post_plugins_fields(opts = {})
      data, _status_code, _headers = post_plugins_fields_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(PluginField, Fixnum, Hash)>] PluginField data, response status code and response headers
    def post_plugins_fields_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsFieldsApi.post_plugins_fields ...'
      end
      # resource path
      local_var_path = '/plugins/fields'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PluginField')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsFieldsApi#post_plugins_fields\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
