...
module Eduframe
  class WebhookNotificationsApi
    ...
    # @return [Array<WebhookNotification>]
    def get_webhooks_webhook_id_notifications(webhook_id, opts = {})
      data, _status_code, _headers = get_webhooks_webhook_id_notifications_with_http_info(webhook_id, opts)
      data
    end
    ...
    # @param webhook_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<WebhookNotification>, Fixnum, Hash)>] Array<WebhookNotification> data, response status code and response headers
    def get_webhooks_webhook_id_notifications_with_http_info(webhook_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhookNotificationsApi.get_webhooks_webhook_id_notifications ...'
      end
      # verify the required parameter 'webhook_id' is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_id' when calling WebhookNotificationsApi.get_webhooks_webhook_id_notifications"
      end
      # resource path
      local_var_path = '/webhooks/{webhook_id}/notifications'.sub('{' + 'webhook_id' + '}', webhook_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<WebhookNotification>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhookNotificationsApi#get_webhooks_webhook_id_notifications\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
