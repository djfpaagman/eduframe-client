...
module Eduframe
  class ReferralsApi
    ...
    def get_referrals(opts = {})
      data, _status_code, _headers = get_referrals_with_http_info(opts)
      data
    end
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Referral>, Fixnum, Hash)>] Array<Referral> data, response status code and response headers
    def get_referrals_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReferralsApi.get_referrals ...'
      end
      # resource path
      local_var_path = '/referrals'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<Referral>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReferralsApi#get_referrals\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
