...
module Eduframe
  class CommentsApi
    ...
    # @return [Comment]
    def delete_comments_id(id, opts = {})
      data, _status_code, _headers = delete_comments_id_with_http_info(id, opts)
      data
    end
    ...
    def delete_comments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommentsApi.delete_comments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CommentsApi.delete_comments_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Comment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommentsApi#delete_comments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Body] :body 
    # @return [Comment]
    def post_comments(opts = {})
      data, _status_code, _headers = post_comments_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Comment, Fixnum, Hash)>] Comment data, response status code and response headers
    def post_comments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommentsApi.post_comments ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Comment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommentsApi#post_comments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a comment.
    ...
    # @option opts [Body] :body 
    # @return [Comment]
    def put_comments_id(id, opts = {})
      data, _status_code, _headers = put_comments_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Comment, Fixnum, Hash)>] Comment data, response status code and response headers
    def put_comments_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommentsApi.put_comments_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CommentsApi.put_comments_id"
      end
      # resource path
      local_var_path = '/comments/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Comment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommentsApi#put_comments_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
