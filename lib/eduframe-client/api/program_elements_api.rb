...
module Eduframe
  class ProgramElementsApi
    ...
    # @return [Element]
    def delete_program_elements_id(id, opts = {})
      data, _status_code, _headers = delete_program_elements_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Element, Fixnum, Hash)>] Element data, response status code and response headers
    def delete_program_elements_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramElementsApi.delete_program_elements_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramElementsApi.delete_program_elements_id"
      end
      # resource path
      local_var_path = '/program/elements/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Element')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramElementsApi#delete_program_elements_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_program_elements(opts = {})
      data, _status_code, _headers = get_program_elements_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :edition_id Filter results on edition_id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<Element>, Fixnum, Hash)>] Array<Element> data, response status code and response headers
    def get_program_elements_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramElementsApi.get_program_elements ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['course', 'planned_course.course_location', 'planned_course.course_variant', 'planned_course'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of course, planned_course.course_location, planned_course.course_variant, planned_course'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['position'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of position'
      end
      # resource path
      local_var_path = '/program/elements'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramElementsApi#get_program_elements\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Element]
    def post_program_elements(opts = {})
      data, _status_code, _headers = post_program_elements_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Element, Fixnum, Hash)>] Element data, response status code and response headers
    def post_program_elements_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramElementsApi.post_program_elements ...'
      end
      # resource path
      local_var_path = '/program/elements'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Element')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramElementsApi#post_program_elements\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Error]
    def post_program_elements_sort(opts = {})
      data, _status_code, _headers = post_program_elements_sort_with_http_info(opts)
      data
    end
    ...
    def post_program_elements_sort_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramElementsApi.post_program_elements_sort ...'
      end
      # resource path
      local_var_path = '/program/elements/sort'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramElementsApi#post_program_elements_sort\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update an element
    ...
    # @option opts [Body] :body 
    # @return [Element]
    def put_program_elements_id(id, opts = {})
      data, _status_code, _headers = put_program_elements_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Element, Fixnum, Hash)>] Element data, response status code and response headers
    def put_program_elements_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramElementsApi.put_program_elements_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramElementsApi.put_program_elements_id"
      end
      # resource path
      local_var_path = '/program/elements/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Element')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramElementsApi#put_program_elements_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
