...
module Eduframe
  class GraduationsApi
    ...
    # @return [Graduation]
    def get_graduation_id(id, opts = {})
      data, _status_code, _headers = get_graduation_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Graduation, Fixnum, Hash)>] Graduation data, response status code and response headers
    def get_graduation_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GraduationsApi.get_graduation_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GraduationsApi.get_graduation_id"
      end
      # resource path
      local_var_path = '/graduation/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Graduation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GraduationsApi#get_graduation_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Graduation]
    def post_graduation(opts = {})
      data, _status_code, _headers = post_graduation_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Graduation, Fixnum, Hash)>] Graduation data, response status code and response headers
    def post_graduation_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GraduationsApi.post_graduation ...'
      end
      # resource path
      local_var_path = '/graduation'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Graduation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GraduationsApi#post_graduation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a graduation
    ...
    # @option opts [Body] :body 
    # @return [Graduation]
    def put_graduation_id(id, opts = {})
      data, _status_code, _headers = put_graduation_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Graduation, Fixnum, Hash)>] Graduation data, response status code and response headers
    def put_graduation_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GraduationsApi.put_graduation_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GraduationsApi.put_graduation_id"
      end
      # resource path
      local_var_path = '/graduation/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Graduation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GraduationsApi#put_graduation_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
