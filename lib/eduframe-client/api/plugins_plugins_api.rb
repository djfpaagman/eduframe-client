...
module Eduframe
  class PluginsPluginsApi
    ...
    # @return [Plugin]
    def get_plugins_plugins_id(id, opts = {})
      data, _status_code, _headers = get_plugins_plugins_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Plugin, Fixnum, Hash)>] Plugin data, response status code and response headers
    def get_plugins_plugins_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsPluginsApi.get_plugins_plugins_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PluginsPluginsApi.get_plugins_plugins_id"
      end
      # resource path
      local_var_path = '/plugins/plugins/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Plugin')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsPluginsApi#get_plugins_plugins_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Plugin]
    def post_plugins_plugins(opts = {})
      data, _status_code, _headers = post_plugins_plugins_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Plugin, Fixnum, Hash)>] Plugin data, response status code and response headers
    def post_plugins_plugins_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsPluginsApi.post_plugins_plugins ...'
      end
      # resource path
      local_var_path = '/plugins/plugins'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Plugin')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsPluginsApi#post_plugins_plugins\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
