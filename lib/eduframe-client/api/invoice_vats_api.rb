...
module Eduframe
  class InvoiceVatsApi
    ...
    # @return [Array<InvoiceVat>]
    def get_invoice_vats(opts = {})
      data, _status_code, _headers = get_invoice_vats_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Array<InvoiceVat>, Fixnum, Hash)>] Array<InvoiceVat> data, response status code and response headers
    def get_invoice_vats_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoiceVatsApi.get_invoice_vats ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of plugin_data.field, plugin_data'
      end
      # resource path
      local_var_path = '/invoice_vats'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<InvoiceVat>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceVatsApi#get_invoice_vats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [InvoiceVat]
    def post_invoice_vats(opts = {})
      data, _status_code, _headers = post_invoice_vats_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(InvoiceVat, Fixnum, Hash)>] InvoiceVat data, response status code and response headers
    def post_invoice_vats_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoiceVatsApi.post_invoice_vats ...'
      end
      # resource path
      local_var_path = '/invoice_vats'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'InvoiceVat')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceVatsApi#post_invoice_vats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
