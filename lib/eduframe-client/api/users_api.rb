...
module Eduframe
  class UsersApi
    ...
    # @option opts [String] :role Filter results on role
    # @option opts [String] :account_id Filter results on account_id
    # @option opts [String] :has_orders Filter results on has_orders
    # @option opts [String] :student Filter results on student
    # @option opts [String] :search Filter results on search
    # @option opts [String] :email Filter results on email
    # @option opts [String] :not_administrator Filter results on not_administrator
    # @option opts [String] :not_teacher Filter results on not_teacher
    ...
    def get_users_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['personal_account', 'role', 'accounts', 'address', 'labels', 'custom', 'signup_answers.signup_question', 'signup_answers'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of personal_account, role, accounts, address, labels, custom, signup_answers.signup_question, signup_answers'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['first_name', 'last_name', 'middle_name', 'email'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of first_name, last_name, middle_name, email'
      end
      # resource path
      ...
      query_params[:'has_orders'] = opts[:'has_orders'] if !opts[:'has_orders'].nil?
      query_params[:'student'] = opts[:'student'] if !opts[:'student'].nil?
      query_params[:'search'] = opts[:'search'] if !opts[:'search'].nil?
      query_params[:'email'] = opts[:'email'] if !opts[:'email'].nil?
      query_params[:'not_administrator'] = opts[:'not_administrator'] if !opts[:'not_administrator'].nil?
      query_params[:'not_teacher'] = opts[:'not_teacher'] if !opts[:'not_teacher'].nil?
    ...
    # @option opts [Body] :body 
    # @return [User]
    def put_users_id(id, opts = {})
      data, _status_code, _headers = put_users_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(User, Fixnum, Hash)>] User data, response status code and response headers
    def put_users_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
