...
module Eduframe
  class ProgramEditionsApi
    ...
    # @return [Edition]
    def delete_program_editions_id(id, opts = {})
      data, _status_code, _headers = delete_program_editions_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Edition, Fixnum, Hash)>] Edition data, response status code and response headers
    def delete_program_editions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEditionsApi.delete_program_editions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramEditionsApi.delete_program_editions_id"
      end
      # resource path
      local_var_path = '/program/editions/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Edition')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEditionsApi#delete_program_editions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_program_editions(opts = {})
      data, _status_code, _headers = get_program_editions_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :program_id Filter results on program_id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<Edition>, Fixnum, Hash)>] Array<Edition> data, response status code and response headers
    def get_program_editions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEditionsApi.get_program_editions ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['catalog_variant', 'program'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of catalog_variant, program'
      end
      ...
      # resource path
      local_var_path = '/program/editions'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<Edition>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEditionsApi#get_program_editions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Edition]
    def get_program_editions_id(id, opts = {})
      data, _status_code, _headers = get_program_editions_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(Edition, Fixnum, Hash)>] Edition data, response status code and response headers
    def get_program_editions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEditionsApi.get_program_editions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramEditionsApi.get_program_editions_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['catalog_variant', 'program'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of catalog_variant, program'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Edition')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEditionsApi#get_program_editions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Edition]
    def post_program_editions(opts = {})
      data, _status_code, _headers = post_program_editions_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Edition, Fixnum, Hash)>] Edition data, response status code and response headers
    def post_program_editions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEditionsApi.post_program_editions ...'
      end
      # resource path
      local_var_path = '/program/editions'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Edition')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEditionsApi#post_program_editions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Edition]
    def put_program_editions_id(id, opts = {})
      data, _status_code, _headers = put_program_editions_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Edition, Fixnum, Hash)>] Edition data, response status code and response headers
    def put_program_editions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramEditionsApi.put_program_editions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramEditionsApi.put_program_editions_id"
      end
      # resource path
      local_var_path = '/program/editions/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Edition')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramEditionsApi#put_program_editions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
