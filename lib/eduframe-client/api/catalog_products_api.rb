...
module Eduframe
  class CatalogProductsApi
    ...
    # @option opts [String] :category_id Filter results on category_id
    # @option opts [String] :productable_type Filter results on productable_type
    ...
    def get_catalog_products(opts = {})
      data, _status_code, _headers = get_catalog_products_with_http_info(opts)
      data
    end
    ...
    def get_catalog_products_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogProductsApi.get_catalog_products ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'custom', 'course_tab_contents.course_tab', 'course_tab_contents', 'plugin_data.field.plugin', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, custom, course_tab_contents.course_tab, course_tab_contents, plugin_data.field.plugin, plugin_data.field, plugin_data'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['id', 'position'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of id, position'
      end
      # resource path
      ...
      query_params[:'productable_type'] = opts[:'productable_type'] if !opts[:'productable_type'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogProductsApi#get_catalog_products\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Product]
    def get_catalog_products_id(id, opts = {})
      data, _status_code, _headers = get_catalog_products_id_with_http_info(id, opts)
      data
    end
    ...
    def get_catalog_products_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogProductsApi.get_catalog_products_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogProductsApi.get_catalog_products_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels', 'custom', 'course_tab_contents.course_tab', 'course_tab_contents', 'plugin_data.field.plugin', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels, custom, course_tab_contents.course_tab, course_tab_contents, plugin_data.field.plugin, plugin_data.field, plugin_data'
      end
      # resource path
      local_var_path = '/catalog/products/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Product')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogProductsApi#get_catalog_products_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Error]
    def post_catalog_products_sort(opts = {})
      data, _status_code, _headers = post_catalog_products_sort_with_http_info(opts)
      data
    end
    ...
    def post_catalog_products_sort_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogProductsApi.post_catalog_products_sort ...'
      end
      # resource path
      local_var_path = '/catalog/products/sort'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogProductsApi#post_catalog_products_sort\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Product]
    def put_catalog_products_id(id, opts = {})
      data, _status_code, _headers = put_catalog_products_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Product, Fixnum, Hash)>] Product data, response status code and response headers
    def put_catalog_products_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogProductsApi.put_catalog_products_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogProductsApi.put_catalog_products_id"
      end
      # resource path
      local_var_path = '/catalog/products/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Product')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogProductsApi#put_catalog_products_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
