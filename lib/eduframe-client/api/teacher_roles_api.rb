...
module Eduframe
  class TeacherRolesApi
    ...
    # @return [TeacherRole]
    def delete_teacher_roles_id(id, opts = {})
      data, _status_code, _headers = delete_teacher_roles_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeacherRole, Fixnum, Hash)>] TeacherRole data, response status code and response headers
    def delete_teacher_roles_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherRolesApi.delete_teacher_roles_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeacherRolesApi.delete_teacher_roles_id"
      end
      # resource path
      local_var_path = '/teacher_roles/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'TeacherRole')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherRolesApi#delete_teacher_roles_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<TeacherRole>]
    def get_teacher_roles(opts = {})
      data, _status_code, _headers = get_teacher_roles_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :id Filter results on id
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<TeacherRole>, Fixnum, Hash)>] Array<TeacherRole> data, response status code and response headers
    def get_teacher_roles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherRolesApi.get_teacher_roles ...'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['name', 'id'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of name, id'
      end
      # resource path
      local_var_path = '/teacher_roles'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<TeacherRole>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherRolesApi#get_teacher_roles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get a teacher role
    ...
    # @param [Hash] opts the optional parameters
    # @return [TeacherRole]
    def get_teacher_roles_id(id, opts = {})
      data, _status_code, _headers = get_teacher_roles_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeacherRole, Fixnum, Hash)>] TeacherRole data, response status code and response headers
    def get_teacher_roles_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherRolesApi.get_teacher_roles_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeacherRolesApi.get_teacher_roles_id"
      end
      # resource path
      local_var_path = '/teacher_roles/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'TeacherRole')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherRolesApi#get_teacher_roles_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [TeacherRole]
    def post_teacher_roles(opts = {})
      data, _status_code, _headers = post_teacher_roles_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(TeacherRole, Fixnum, Hash)>] TeacherRole data, response status code and response headers
    def post_teacher_roles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherRolesApi.post_teacher_roles ...'
      end
      # resource path
      local_var_path = '/teacher_roles'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'TeacherRole')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherRolesApi#post_teacher_roles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [TeacherRole]
    def put_teacher_roles_id(id, opts = {})
      data, _status_code, _headers = put_teacher_roles_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(TeacherRole, Fixnum, Hash)>] TeacherRole data, response status code and response headers
    def put_teacher_roles_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeacherRolesApi.put_teacher_roles_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeacherRolesApi.put_teacher_roles_id"
      end
      # resource path
      local_var_path = '/teacher_roles/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'TeacherRole')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeacherRolesApi#put_teacher_roles_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
