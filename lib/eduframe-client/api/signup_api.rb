...
module Eduframe
  class SignupApi
    ...
    # @return [Error]
    def post_signup(opts = {})
      data, _status_code, _headers = post_signup_with_http_info(opts)
      data
    end
    ...
    def post_signup_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignupApi.post_signup ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignupApi#post_signup\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
