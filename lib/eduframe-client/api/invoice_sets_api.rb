...
module Eduframe
  class InvoiceSetsApi
    ...
    # @return [InvoiceSet]
    def get_invoice_sets_id(id, opts = {})
      data, _status_code, _headers = get_invoice_sets_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvoiceSet, Fixnum, Hash)>] InvoiceSet data, response status code and response headers
    def get_invoice_sets_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoiceSetsApi.get_invoice_sets_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceSetsApi.get_invoice_sets_id"
      end
      # resource path
      local_var_path = '/invoice_sets/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'InvoiceSet')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceSetsApi#get_invoice_sets_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
