...
module Eduframe
  class WorkflowDispatchesApi
    ...
    # @return [Dispatch]
    def delete_workflow_dispatches_id(id, opts = {})
      data, _status_code, _headers = delete_workflow_dispatches_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Dispatch, Fixnum, Hash)>] Dispatch data, response status code and response headers
    def delete_workflow_dispatches_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowDispatchesApi.delete_workflow_dispatches_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowDispatchesApi.delete_workflow_dispatches_id"
      end
      # resource path
      local_var_path = '/workflow/dispatches/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowDispatchesApi#delete_workflow_dispatches_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
