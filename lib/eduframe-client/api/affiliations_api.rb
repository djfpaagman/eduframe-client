...
module Eduframe
  class AffiliationsApi
    ...
    # @return [Affiliation]
    def delete_affiliations_id(id, opts = {})
      data, _status_code, _headers = delete_affiliations_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Affiliation, Fixnum, Hash)>] Affiliation data, response status code and response headers
    def delete_affiliations_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AffiliationsApi.delete_affiliations_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AffiliationsApi.delete_affiliations_id"
      end
      # resource path
      local_var_path = '/affiliations/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'Affiliation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AffiliationsApi#delete_affiliations_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :key_contact Filter results on key_contact
    ...
    def get_affiliations(opts = {})
      data, _status_code, _headers = get_affiliations_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :search Filter results on search
    # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
    # @return [Array<(Array<Affiliation>, Fixnum, Hash)>] Array<Affiliation> data, response status code and response headers
    def get_affiliations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AffiliationsApi.get_affiliations ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['account', 'user.labels', 'user'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of account, user.labels, user'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['id', 'key_contact', 'users.first_name', 'users'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of id, key_contact, users.first_name, users'
      end
      # resource path
      local_var_path = '/affiliations'
      ...
      query_params[:'key_contact'] = opts[:'key_contact'] if !opts[:'key_contact'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<Affiliation>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AffiliationsApi#get_affiliations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Affiliation]
    def post_affiliations(opts = {})
      data, _status_code, _headers = post_affiliations_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Affiliation, Fixnum, Hash)>] Affiliation data, response status code and response headers
    def post_affiliations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AffiliationsApi.post_affiliations ...'
      end
      # resource path
      local_var_path = '/affiliations'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Affiliation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AffiliationsApi#post_affiliations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Affiliation]
    def put_affiliations_id(id, opts = {})
      data, _status_code, _headers = put_affiliations_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Affiliation, Fixnum, Hash)>] Affiliation data, response status code and response headers
    def put_affiliations_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AffiliationsApi.put_affiliations_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AffiliationsApi.put_affiliations_id"
      end
      # resource path
      local_var_path = '/affiliations/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Affiliation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AffiliationsApi#put_affiliations_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
