...
module Eduframe
  class TeachersApi
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [User]
    def get_teachers_id(id, opts = {})
      data, _status_code, _headers = get_teachers_id_with_http_info(id, opts)
      data
    end
    ...
    def get_teachers_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeachersApi.get_teachers_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeachersApi.get_teachers_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['labels'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of labels'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'User')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeachersApi#get_teachers_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
