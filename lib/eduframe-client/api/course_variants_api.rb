...
module Eduframe
  class CourseVariantsApi
    ...
    # @return [Array<CourseVariant>]
    def get_course_variants(opts = {})
      data, _status_code, _headers = get_course_variants_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :search Filter results on search
    # @option opts [Array<String>] :id Filter results on id
    # @return [Array<(Array<CourseVariant>, Fixnum, Hash)>] Array<CourseVariant> data, response status code and response headers
    def get_course_variants_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseVariantsApi.get_course_variants ...'
      end
      # resource path
      local_var_path = '/course_variants'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<CourseVariant>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseVariantsApi#get_course_variants\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_course_variants_id(id, opts = {})
      data, _status_code, _headers = get_course_variants_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CourseVariant, Fixnum, Hash)>] CourseVariant data, response status code and response headers
    def get_course_variants_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseVariantsApi.get_course_variants_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CourseVariantsApi.get_course_variants_id"
      end
      # resource path
      local_var_path = '/course_variants/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CourseVariant')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseVariantsApi#get_course_variants_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [CourseVariant]
    def post_course_variants(opts = {})
      data, _status_code, _headers = post_course_variants_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(CourseVariant, Fixnum, Hash)>] CourseVariant data, response status code and response headers
    def post_course_variants_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseVariantsApi.post_course_variants ...'
      end
      # resource path
      local_var_path = '/course_variants'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CourseVariant')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseVariantsApi#post_course_variants\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
