...
module Eduframe
  class CalendarEventsApi
    ...
    # @option opts [String] :bookable_type Filter results on bookable_type
    # @option opts [String] :bookable_id Filter results on bookable_id
    # @return [Array<CalendarEvent>]
    def get_calendar_events(opts = {})
      data, _status_code, _headers = get_calendar_events_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :bookable_type Filter results on bookable_type
    # @option opts [String] :bookable_id Filter results on bookable_id
    # @return [Array<(Array<CalendarEvent>, Fixnum, Hash)>] Array<CalendarEvent> data, response status code and response headers
    def get_calendar_events_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CalendarEventsApi.get_calendar_events ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['calendar_bookings'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of calendar_bookings'
      end
      # resource path
      local_var_path = '/calendar/events'
      ...
      query_params[:'bookable_type'] = opts[:'bookable_type'] if !opts[:'bookable_type'].nil?
      query_params[:'bookable_id'] = opts[:'bookable_id'] if !opts[:'bookable_id'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<CalendarEvent>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CalendarEventsApi#get_calendar_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_calendar_events_id(id, opts = {})
      data, _status_code, _headers = get_calendar_events_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(CalendarEvent, Fixnum, Hash)>] CalendarEvent data, response status code and response headers
    def get_calendar_events_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CalendarEventsApi.get_calendar_events_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CalendarEventsApi.get_calendar_events_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['calendar_bookings'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of calendar_bookings'
      end
      # resource path
      local_var_path = '/calendar/events/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CalendarEventsApi#get_calendar_events_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [CalendarEvent]
    def post_calendar_events(opts = {})
      data, _status_code, _headers = post_calendar_events_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(CalendarEvent, Fixnum, Hash)>] CalendarEvent data, response status code and response headers
    def post_calendar_events_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CalendarEventsApi.post_calendar_events ...'
      end
      # resource path
      local_var_path = '/calendar/events'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CalendarEvent')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CalendarEventsApi#post_calendar_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
