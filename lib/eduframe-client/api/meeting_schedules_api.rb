...
module Eduframe
  class MeetingSchedulesApi
    ...
    # @return [Array<MeetingSchedule>]
    def post_meeting_schedules(opts = {})
      data, _status_code, _headers = post_meeting_schedules_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(Array<MeetingSchedule>, Fixnum, Hash)>] Array<MeetingSchedule> data, response status code and response headers
    def post_meeting_schedules_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MeetingSchedulesApi.post_meeting_schedules ...'
      end
      # resource path
      local_var_path = '/meeting_schedules'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Array<MeetingSchedule>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeetingSchedulesApi#post_meeting_schedules\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
