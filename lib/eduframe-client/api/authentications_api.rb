...
module Eduframe
  class AuthenticationsApi
    ...
    def post_authentications(opts = {})
      data, _status_code, _headers = post_authentications_with_http_info(opts)
      data
    end
    ...
    def post_authentications_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthenticationsApi.post_authentications ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthenticationsApi#post_authentications\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Body] :body 
    # @return [Error]
    def post_authentications_availability(opts = {})
      data, _status_code, _headers = post_authentications_availability_with_http_info(opts)
      data
    end
    ...
    def post_authentications_availability_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthenticationsApi.post_authentications_availability ...'
      end
      # resource path
      local_var_path = '/authentications/availability'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthenticationsApi#post_authentications_availability\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
