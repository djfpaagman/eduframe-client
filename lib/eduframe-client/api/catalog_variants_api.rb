...
module Eduframe
  class CatalogVariantsApi
    ...
    # @option opts [String] :product_id Filter results on product_id
    ...
    def get_catalog_variants_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogVariantsApi.get_catalog_variants ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['product', 'plugin_data.field.plugin', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of product, plugin_data.field.plugin, plugin_data.field, plugin_data'
      end
      # resource path
      local_var_path = '/catalog/variants'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogVariantsApi#get_catalog_variants\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Variant]
    def get_catalog_variants_id(id, opts = {})
      data, _status_code, _headers = get_catalog_variants_id_with_http_info(id, opts)
      data
    end
    ...
    def get_catalog_variants_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogVariantsApi.get_catalog_variants_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogVariantsApi.get_catalog_variants_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['product', 'plugin_data.field.plugin', 'plugin_data.field', 'plugin_data'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of product, plugin_data.field.plugin, plugin_data.field, plugin_data'
      end
      # resource path
      local_var_path = '/catalog/variants/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Variant')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogVariantsApi#get_catalog_variants_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Variant]
    def put_catalog_variants_id(id, opts = {})
      data, _status_code, _headers = put_catalog_variants_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Variant, Fixnum, Hash)>] Variant data, response status code and response headers
    def put_catalog_variants_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogVariantsApi.put_catalog_variants_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogVariantsApi.put_catalog_variants_id"
      end
      # resource path
      local_var_path = '/catalog/variants/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Variant')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CatalogVariantsApi#put_catalog_variants_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
