...
module Eduframe
  class PaymentOptionsApi
    ...
    # @option opts [String] :available_for_cost Filter results on available_for_cost
    # @return [Array<PaymentOption>]
    def get_payment_options(opts = {})
      data, _status_code, _headers = get_payment_options_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :available_for_cost Filter results on available_for_cost
    # @return [Array<(Array<PaymentOption>, Fixnum, Hash)>] Array<PaymentOption> data, response status code and response headers
    def get_payment_options_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentOptionsApi.get_payment_options ...'
      end
      # resource path
      local_var_path = '/payment_options'

      # query parameters
      query_params = {}
      query_params[:'available_for_cost'] = opts[:'available_for_cost'] if !opts[:'available_for_cost'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<PaymentOption>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentOptionsApi#get_payment_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
