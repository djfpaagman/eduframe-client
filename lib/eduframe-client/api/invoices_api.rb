...
module Eduframe
  class InvoicesApi
    ...
    # @option opts [String] :plugin_data_value Filter results on plugin_data_value
    # @option opts [String] :plugin_data_field_title Filter results on plugin_data_field_title
    # @option opts [String] :plugin_data_plugin_name Filter results on plugin_data_plugin_name
    ...
    def get_invoices_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['plugin_data.field.plugin', 'plugin_data.field', 'plugin_data', 'order.creator', 'order', 'payments.plugin_data.field', 'payments.plugin_data', 'payments', 'invoice_items.invoice_vat', 'invoice_items.plugin_data.field', 'invoice_items.plugin_data', 'invoice_items'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of plugin_data.field.plugin, plugin_data.field, plugin_data, order.creator, order, payments.plugin_data.field, payments.plugin_data, payments, invoice_items.invoice_vat, invoice_items.plugin_data.field, invoice_items.plugin_data, invoice_items'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['id', 'number_int', 'number', 'opened_at', 'status', 'company_name'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of id, number_int, number, opened_at, status, company_name'
      end
      # resource path
      ...
      query_params[:'plugin_data_value'] = opts[:'plugin_data_value'] if !opts[:'plugin_data_value'].nil?
      query_params[:'plugin_data_field_title'] = opts[:'plugin_data_field_title'] if !opts[:'plugin_data_field_title'].nil?
      query_params[:'plugin_data_plugin_name'] = opts[:'plugin_data_plugin_name'] if !opts[:'plugin_data_plugin_name'].nil?
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Invoice]
    def get_invoices_id(id, opts = {})
      data, _status_code, _headers = get_invoices_id_with_http_info(id, opts)
      data
    end
    ...
    def get_invoices_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.get_invoices_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.get_invoices_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['plugin_data.field.plugin', 'plugin_data.field', 'plugin_data', 'order.creator', 'order', 'payments.plugin_data.field', 'payments.plugin_data', 'payments', 'invoice_items.invoice_vat', 'invoice_items.plugin_data.field', 'invoice_items.plugin_data', 'invoice_items'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of plugin_data.field.plugin, plugin_data.field, plugin_data, order.creator, order, payments.plugin_data.field, payments.plugin_data, payments, invoice_items.invoice_vat, invoice_items.plugin_data.field, invoice_items.plugin_data, invoice_items'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Invoice')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#get_invoices_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def get_invoices_id_pdf(id, opts = {})
      data, _status_code, _headers = get_invoices_id_pdf_with_http_info(id, opts)
      data
    end
    ...
    def get_invoices_id_pdf_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.get_invoices_id_pdf ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.get_invoices_id_pdf"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Object')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#get_invoices_id_pdf\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create an invoice.
    ...
    # @return [Invoice]
    def post_invoices(opts = {})
      data, _status_code, _headers = post_invoices_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Invoice, Fixnum, Hash)>] Invoice data, response status code and response headers
    def post_invoices_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.post_invoices ...'
      end
      # resource path
      local_var_path = '/invoices'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Invoice')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#post_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Invoice]
    def post_invoices_id_open(id, opts = {})
      data, _status_code, _headers = post_invoices_id_open_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Invoice, Fixnum, Hash)>] Invoice data, response status code and response headers
    def post_invoices_id_open_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.post_invoices_id_open ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.post_invoices_id_open"
      end
      # resource path
      local_var_path = '/invoices/{id}/open'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Invoice')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#post_invoices_id_open\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
