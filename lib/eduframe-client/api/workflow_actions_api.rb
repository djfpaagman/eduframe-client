...
module Eduframe
  class WorkflowActionsApi
    ...
    def delete_workflow_actions_id(id, opts = {})
      data, _status_code, _headers = delete_workflow_actions_id_with_http_info(id, opts)
      data
    end
    ...
    def delete_workflow_actions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowActionsApi.delete_workflow_actions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionsApi.delete_workflow_actions_id"
      end
      # resource path
      local_var_path = '/workflow/actions/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowActionsApi#delete_workflow_actions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :template_id Filter results on template_id
    # @option opts [String] :event Filter results on event
    # @option opts [String] :relative_to Filter results on relative_to
    # @option opts [String] :not_course_related Filter results on not_course_related
    # @option opts [Array<String>] :type Filter results on type
    # @return [Array<WorkflowAction>]
    def get_workflow_actions(opts = {})
      data, _status_code, _headers = get_workflow_actions_with_http_info(opts)
      data
    end
    ...
    def get_workflow_actions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowActionsApi.get_workflow_actions ...'
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['template.assignee', 'template'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of template.assignee, template'
      end
      # resource path
      local_var_path = '/workflow/actions'
      ...
      query_params[:'relative_to'] = opts[:'relative_to'] if !opts[:'relative_to'].nil?
      query_params[:'not_course_related'] = opts[:'not_course_related'] if !opts[:'not_course_related'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowActionsApi#get_workflow_actions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get a action record
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [WorkflowAction]
    def get_workflow_actions_id(id, opts = {})
      data, _status_code, _headers = get_workflow_actions_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Array<(WorkflowAction, Fixnum, Hash)>] WorkflowAction data, response status code and response headers
    def get_workflow_actions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowActionsApi.get_workflow_actions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionsApi.get_workflow_actions_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['template.assignee', 'template'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of template.assignee, template'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'WorkflowAction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowActionsApi#get_workflow_actions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create an action.
    ...
    # @option opts [Body] :body 
    # @return [WorkflowAction]
    def post_workflow_actions(opts = {})
      data, _status_code, _headers = post_workflow_actions_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(WorkflowAction, Fixnum, Hash)>] WorkflowAction data, response status code and response headers
    def post_workflow_actions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowActionsApi.post_workflow_actions ...'
      end
      # resource path
      local_var_path = '/workflow/actions'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'WorkflowAction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowActionsApi#post_workflow_actions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update an action.
    ...
    # @option opts [Body] :body 
    # @return [WorkflowAction]
    def put_workflow_actions_id(id, opts = {})
      data, _status_code, _headers = put_workflow_actions_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(WorkflowAction, Fixnum, Hash)>] WorkflowAction data, response status code and response headers
    def put_workflow_actions_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowActionsApi.put_workflow_actions_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionsApi.put_workflow_actions_id"
      end
      # resource path
      local_var_path = '/workflow/actions/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'WorkflowAction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowActionsApi#put_workflow_actions_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
