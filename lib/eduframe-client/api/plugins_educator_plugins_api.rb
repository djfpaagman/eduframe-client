...
module Eduframe
  class PluginsEducatorPluginsApi
    ...
    # @return [EducatorPlugin]
    def get_plugins_educators_id(id, opts = {})
      data, _status_code, _headers = get_plugins_educators_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EducatorPlugin, Fixnum, Hash)>] EducatorPlugin data, response status code and response headers
    def get_plugins_educators_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsEducatorPluginsApi.get_plugins_educators_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PluginsEducatorPluginsApi.get_plugins_educators_id"
      end
      # resource path
      local_var_path = '/plugins/educators/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'EducatorPlugin')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsEducatorPluginsApi#get_plugins_educators_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [EducatorPlugin]
    def post_plugins_educators(opts = {})
      data, _status_code, _headers = post_plugins_educators_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(EducatorPlugin, Fixnum, Hash)>] EducatorPlugin data, response status code and response headers
    def post_plugins_educators_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsEducatorPluginsApi.post_plugins_educators ...'
      end
      # resource path
      local_var_path = '/plugins/educators'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'EducatorPlugin')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsEducatorPluginsApi#post_plugins_educators\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [EducatorPlugin]
    def put_plugins_educators_id(id, opts = {})
      data, _status_code, _headers = put_plugins_educators_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(EducatorPlugin, Fixnum, Hash)>] EducatorPlugin data, response status code and response headers
    def put_plugins_educators_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PluginsEducatorPluginsApi.put_plugins_educators_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PluginsEducatorPluginsApi.put_plugins_educators_id"
      end
      # resource path
      local_var_path = '/plugins/educators/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'EducatorPlugin')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PluginsEducatorPluginsApi#put_plugins_educators_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
