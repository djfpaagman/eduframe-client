...
module Eduframe
  class AttendancesApi
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Attendance>, Fixnum, Hash)>] Array<Attendance> data, response status code and response headers
    def get_attendances_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AttendancesApi.get_attendances ...'
      end
      # resource path
      local_var_path = '/attendances'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<Attendance>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttendancesApi#get_attendances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Attendance]
    def put_attendances_id(id, opts = {})
      data, _status_code, _headers = put_attendances_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(Attendance, Fixnum, Hash)>] Attendance data, response status code and response headers
    def put_attendances_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AttendancesApi.put_attendances_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AttendancesApi.put_attendances_id"
      end
      # resource path
      local_var_path = '/attendances/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttendancesApi#put_attendances_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
