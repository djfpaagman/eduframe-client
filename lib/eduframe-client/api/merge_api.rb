...
module Eduframe
  class MergeApi
    ...
    # @return [Merge]
    def post_merge_users(opts = {})
      data, _status_code, _headers = post_merge_users_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Body] :body 
    # @return [Array<(Merge, Fixnum, Hash)>] Merge data, response status code and response headers
    def post_merge_users_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MergeApi.post_merge_users ...'
      end
      # resource path
      local_var_path = '/merge/users'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Merge')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MergeApi#post_merge_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
