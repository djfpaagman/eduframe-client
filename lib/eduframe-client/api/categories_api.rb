...
module Eduframe
  class CategoriesApi
    ...
    # @option opts [String] :parent_id Filter results on parent_id
    ...
    # @param [Hash] opts the optional parameters
    # @return [Category]
    def get_categories_id(id, opts = {})
      data, _status_code, _headers = get_categories_id_with_http_info(id, opts)
      data
    end
    ...
    def get_categories_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CategoriesApi.get_categories_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.get_categories_id"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#get_categories_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a category.
    ...
    # @return [Category]
    def post_categories(opts = {})
      data, _status_code, _headers = post_categories_with_http_info(opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Category, Fixnum, Hash)>] Category data, response status code and response headers
    def post_categories_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CategoriesApi.post_categories ...'
      end
      # resource path
      local_var_path = '/categories'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Category')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#post_categories\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Body] :body 
    # @return [Error]
    def post_categories_sort(opts = {})
      data, _status_code, _headers = post_categories_sort_with_http_info(opts)
      data
    end
    ...
    def post_categories_sort_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CategoriesApi.post_categories_sort ...'
      end
      # resource path
      local_var_path = '/categories/sort'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#post_categories_sort\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a category.
    ...
    # @option opts [Body] :body 
    # @return [Category]
    def put_categories_id(id, opts = {})
      data, _status_code, _headers = put_categories_id_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Category, Fixnum, Hash)>] Category data, response status code and response headers
    def put_categories_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CategoriesApi.put_categories_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.put_categories_id"
      end
      # resource path
      local_var_path = '/categories/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Category')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#put_categories_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
