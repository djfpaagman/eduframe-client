...
module Eduframe
  class CourseTabsApi
    ...
    # @return [Array<CourseTab>]
    def get_course_tabs(opts = {})
      data, _status_code, _headers = get_course_tabs_with_http_info(opts)
      data
    end
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<CourseTab>, Fixnum, Hash)>] Array<CourseTab> data, response status code and response headers
    def get_course_tabs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CourseTabsApi.get_course_tabs ...'
      end
      # resource path
      local_var_path = '/course_tabs'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<CourseTab>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CourseTabsApi#get_course_tabs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
