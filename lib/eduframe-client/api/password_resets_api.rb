...
module Eduframe
  class PasswordResetsApi
    ...
    # @return [Error]
    def post_password_resets(opts = {})
      data, _status_code, _headers = post_password_resets_with_http_info(opts)
      data
    end
    ...
    def post_password_resets_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PasswordResetsApi.post_password_resets ...'
      end
      # resource path
      local_var_path = '/password_resets'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Error')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PasswordResetsApi#post_password_resets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
