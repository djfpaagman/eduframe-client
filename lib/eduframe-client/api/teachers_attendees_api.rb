...
module Eduframe
  class TeachersAttendeesApi
    ...
    # @return [Array<TeacherAttendee>]
    def get_planned_courses_planned_course_id_teacher_attendees(planned_course_id, opts = {})
      data, _status_code, _headers = get_planned_courses_planned_course_id_teacher_attendees_with_http_info(planned_course_id, opts)
      data
    end
    ...
    # @param planned_course_id Filter results on planned_course_id
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<TeacherAttendee>, Fixnum, Hash)>] Array<TeacherAttendee> data, response status code and response headers
    def get_planned_courses_planned_course_id_teacher_attendees_with_http_info(planned_course_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeachersAttendeesApi.get_planned_courses_planned_course_id_teacher_attendees ...'
      end
      # verify the required parameter 'planned_course_id' is set
      if @api_client.config.client_side_validation && planned_course_id.nil?
        fail ArgumentError, "Missing the required parameter 'planned_course_id' when calling TeachersAttendeesApi.get_planned_courses_planned_course_id_teacher_attendees"
      end
      # resource path
      local_var_path = '/planned_courses/{planned_course_id}/teacher_attendees'.sub('{' + 'planned_course_id' + '}', planned_course_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<TeacherAttendee>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeachersAttendeesApi#get_planned_courses_planned_course_id_teacher_attendees\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
