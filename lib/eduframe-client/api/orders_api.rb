...
module Eduframe
  class OrdersApi
    ...
    # @option opts [String] :account_id Filter results on account_id
    # @option opts [String] :catalog_variant_id Filter results on catalog_variant_id
    # @option opts [String] :creator_id Filter results on creator_id
    # @option opts [String] :created_at_after Filter results on created_at_after
    # @option opts [String] :created_at_before Filter results on created_at_before
    # @option opts [String] :number Filter results on number
    # @option opts [String] :search Filter results on search
    # @option opts [String] :user_id Filter results on user_id
    # @option opts [Array<String>] :catalog_product_id Filter results on catalog_product_id
    ...
    # @option opts [Array<String>] :label_id Filter results on label_id
    ...
    def get_orders_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['account', 'catalog_product', 'catalog_variant', 'creator', 'labels', 'custom', 'enrollments.student', 'enrollments.certificate', 'enrollments.planned_course.course', 'enrollments.planned_course.course_location', 'enrollments.planned_course.course_variant', 'enrollments.planned_course.teachers', 'enrollments.planned_course', 'enrollments'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of account, catalog_product, catalog_variant, creator, labels, custom, enrollments.student, enrollments.certificate, enrollments.planned_course.course, enrollments.planned_course.course_location, enrollments.planned_course.course_variant, enrollments.planned_course.teachers, enrollments.planned_course, enrollments'
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !opts[:'sort'].all? { |item| ['cost', 'created_at', 'number', 'status', 'users.first_name', 'users'].include?(item) }
        fail ArgumentError, 'invalid value for "sort", must include one of cost, created_at, number, status, users.first_name, users'
      end
      # resource path
      ...
      query_params[:'catalog_variant_id'] = opts[:'catalog_variant_id'] if !opts[:'catalog_variant_id'].nil?
      ...
      query_params[:'catalog_product_id'] = @api_client.build_collection_param(opts[:'catalog_product_id'], :csv) if !opts[:'catalog_product_id'].nil?
      ...
      query_params[:'label_id'] = @api_client.build_collection_param(opts[:'label_id'], :csv) if !opts[:'label_id'].nil?
    ...
    # @option opts [Array<String>] :include Include relations
    # @return [Order]
    def get_orders_id(id, opts = {})
      data, _status_code, _headers = get_orders_id_with_http_info(id, opts)
      data
    end
    ...
    def get_orders_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.get_orders_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrdersApi.get_orders_id"
      end
      if @api_client.config.client_side_validation && opts[:'include'] && !opts[:'include'].all? { |item| ['account', 'catalog_product', 'catalog_variant', 'creator', 'labels', 'custom', 'enrollments.student', 'enrollments.certificate', 'enrollments.planned_course.course', 'enrollments.planned_course.course_location', 'enrollments.planned_course.course_variant', 'enrollments.planned_course.teachers', 'enrollments.planned_course', 'enrollments'].include?(item) }
        fail ArgumentError, 'invalid value for "include", must include one of account, catalog_product, catalog_variant, creator, labels, custom, enrollments.student, enrollments.certificate, enrollments.planned_course.course, enrollments.planned_course.course_location, enrollments.planned_course.course_variant, enrollments.planned_course.teachers, enrollments.planned_course, enrollments'
      end
    ...
    # @option opts [Body] :body 
    # @return [Order]
    def put_orders_id_approve(id, opts = {})
      data, _status_code, _headers = put_orders_id_approve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Order, Fixnum, Hash)>] Order data, response status code and response headers
    def put_orders_id_approve_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.put_orders_id_approve ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrdersApi.put_orders_id_approve"
      end
      # resource path
      local_var_path = '/orders/{id}/approve'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Order')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#put_orders_id_approve\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Cancel an order
    ...
    # @option opts [Body] :body 
    # @return [Order]
    def put_orders_id_cancel(id, opts = {})
      data, _status_code, _headers = put_orders_id_cancel_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Order, Fixnum, Hash)>] Order data, response status code and response headers
    def put_orders_id_cancel_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.put_orders_id_cancel ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrdersApi.put_orders_id_cancel"
      end
      # resource path
      local_var_path = '/orders/{id}/cancel'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Order')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#put_orders_id_cancel\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Deny an order
    ...
    # @option opts [Body] :body 
    # @return [Order]
    def put_orders_id_deny(id, opts = {})
      data, _status_code, _headers = put_orders_id_deny_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Body] :body 
    # @return [Array<(Order, Fixnum, Hash)>] Order data, response status code and response headers
    def put_orders_id_deny_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.put_orders_id_deny ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrdersApi.put_orders_id_deny"
      end
      # resource path
      local_var_path = '/orders/{id}/deny'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Order')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#put_orders_id_deny\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
