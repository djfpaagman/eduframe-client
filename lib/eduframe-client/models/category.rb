...
module Eduframe
  class Category
    ...
    # Number of products directly linked to this category.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'courses_count')
        self.courses_count = attributes[:'courses_count']
      end

      if attributes.has_key?(:'children_count')
    ...
    def list_invalid_properties
      ...
      if @courses_count.nil?
        invalid_properties.push('invalid value for "courses_count", courses_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @courses_count.nil?
    ...
    def hash
      [id, position, avatar, avatar_url, products_count, courses_count, children_count, created_at, updated_at, name, slug, description, is_published, meta_title, meta_description, parent_id].hash
    end
