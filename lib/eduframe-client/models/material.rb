...
module Eduframe
  class Material
    ...
    # Type of material. i.e. consumable or reservable
    attr_accessor :use_type

    # Unique identifier of the material group.
    attr_accessor :material_group_id

    attr_accessor :material_group
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'use_type')
        self.use_type = attributes[:'use_type']
      end

      if attributes.has_key?(:'material_group_id')
        self.material_group_id = attributes[:'material_group_id']
      end

      if attributes.has_key?(:'material_group')
        self.material_group = attributes[:'material_group']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @material_group_id.nil?
        invalid_properties.push('invalid value for "material_group_id", material_group_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @material_group_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          use_type == o.use_type &&
          material_group_id == o.material_group_id &&
          material_group == o.material_group
    end
    ...
    def hash
      [id, created_at, updated_at, name, use_type, material_group_id, material_group].hash
    end
