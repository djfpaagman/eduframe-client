...
module Eduframe
  class DuplicateUser
    ...
    # Identifier of the primary user
    attr_accessor :user_id

    # Identifier of the secondary user
    attr_accessor :duplicate_user_id

    attr_accessor :user

    attr_accessor :duplicate_user

    # Boolean indicating if duplicate record is dismissed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'duplicate_user_id')
        self.duplicate_user_id = attributes[:'duplicate_user_id']
      end
      ...
      if attributes.has_key?(:'duplicate_user')
        self.duplicate_user = attributes[:'duplicate_user']
      end

      if attributes.has_key?(:'dismissed')
    ...
    def list_invalid_properties
      ...
      if @duplicate_user_id.nil?
        invalid_properties.push('invalid value for "duplicate_user_id", duplicate_user_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @duplicate_user_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          user_id == o.user_id &&
          duplicate_user_id == o.duplicate_user_id &&
          user == o.user &&
          duplicate_user == o.duplicate_user &&
    ...
    def hash
      [id, user_id, duplicate_user_id, user, duplicate_user, dismissed].hash
    end
