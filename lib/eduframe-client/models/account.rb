...
module Eduframe
  class Account
    ...
    # Unique identifier of the linked user account. If set it is a personal account type.
    attr_accessor :personal_user_id

    # Helper to identify the type of account. If it is personal, you can also see that since the personal_user_id is set.
    attr_accessor :account_type

    # Number of users directly linked to this account.
    ...
    attr_accessor :key_contacts

    attr_accessor :labels

    attr_accessor :signup_answers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'personal_user_id')
        self.personal_user_id = attributes[:'personal_user_id']
      end
      ...
      if attributes.has_key?(:'users_count')
      ...
      if attributes.has_key?(:'key_contacts')
        if (value = attributes[:'key_contacts']).is_a?(Array)
          self.key_contacts = value
        end
      end
      ...
      if attributes.has_key?(:'signup_answers')
        if (value = attributes[:'signup_answers']).is_a?(Array)
          self.signup_answers = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @personal_user_id.nil?
        invalid_properties.push('invalid value for "personal_user_id", personal_user_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @personal_user_id.nil?
      return false if @account_type.nil?
      account_type_validator = EnumAttributeValidator.new('String', ['business', 'personal'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          slug == o.slug &&
          visible == o.visible &&
          personal_user_id == o.personal_user_id &&
          ...
          phone == o.phone &&
          address == o.address &&
          key_contacts == o.key_contacts &&
          labels == o.labels &&
          signup_answers == o.signup_answers &&
    ...
    def hash
      [id, slug, visible, personal_user_id, account_type, users_count, created_at, updated_at, name, email, phone, address, key_contacts, labels, signup_answers, plugin_data].hash
    end
