...
module Eduframe
  class Grade
    ...
    # The actual grade which is either the grade or the score / denominator
    ...
    attr_accessor :gradeable_id

    # Model type of the gradeable (enrollment / ...)
    attr_accessor :gradeable_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gradeable_id')
        self.gradeable_id = attributes[:'gradeable_id']
      end

      if attributes.has_key?(:'gradeable_type')
        self.gradeable_type = attributes[:'gradeable_type']
      end
    ...
    def list_invalid_properties
      ...
      if @gradeable_id.nil?
        invalid_properties.push('invalid value for "gradeable_id", gradeable_id cannot be nil.')
      end

      if @gradeable_type.nil?
        invalid_properties.push('invalid value for "gradeable_type", gradeable_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gradeable_id.nil?
      return false if @gradeable_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gradeable_id == o.gradeable_id &&
          gradeable_type == o.gradeable_type &&
          comment == o.comment
    end
    ...
    def hash
      [id, grader_id, result, created_at, updated_at, grade, score, denominator, gradeable_id, gradeable_type, comment].hash
    end
