...
module Eduframe
  class Affiliation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'key_contact')
        self.key_contact = attributes[:'key_contact']
      end
    ...
    def hash
      [id, created_at, updated_at, key_contact, user_id, account_id, account, user].hash
    end
