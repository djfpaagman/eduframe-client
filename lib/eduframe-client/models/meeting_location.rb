...
module Eduframe
  class MeetingLocation
    ...
    def list_invalid_properties
      ...
      if @course_location_id.nil?
        invalid_properties.push('invalid value for "course_location_id", course_location_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @course_location_id.nil?
      true
    end
    ...
    def hash
      [id, created_at, updated_at, name, course_location_id, capacity, address, course_location].hash
    end
