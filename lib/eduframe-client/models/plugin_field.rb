...
module Eduframe
  class PluginField
    # Identifier of the plugin_field.
    attr_accessor :id
    ...
    # Boolean representing if the field is unique. The default unique status is false.
    ...
    def valid?
      ...
      data_type_validator = EnumAttributeValidator.new('String', ['integer', 'string', 'date', 'table', 'boolean'])
    ...
    def data_type=(data_type)
      validator = EnumAttributeValidator.new('String', ['integer', 'string', 'date', 'table', 'boolean'])
    ...
    def hash
      [id, title, data_type, unique, plugin].hash
    end
