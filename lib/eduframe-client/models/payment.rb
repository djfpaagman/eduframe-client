...
module Eduframe
  class Payment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gateway_id')
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['new', 'open', 'paid', 'failed', 'internal_server_error'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['new', 'open', 'paid', 'failed', 'internal_server_error'])
    ...
    def hash
      [id, invoice_id, gateway_id, status, amount, currency, date, payment_method_id, payment_method, plugin_data].hash
    end
