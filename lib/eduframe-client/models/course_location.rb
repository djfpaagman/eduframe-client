...
module Eduframe
  class CourseLocation
    ...
    attr_accessor :meeting_locations
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'address' => :'Object',
        :'meeting_locations' => :'Array<Object>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'meeting_locations')
        if (value = attributes[:'meeting_locations']).is_a?(Array)
          self.meeting_locations = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          address == o.address &&
          meeting_locations == o.meeting_locations
    end
    ...
    def hash
      [id, created_at, updated_at, name, address, meeting_locations].hash
    end
