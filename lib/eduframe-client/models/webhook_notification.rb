...
module Eduframe
  class WebhookNotification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'send_attempts')
        if (value = attributes[:'send_attempts']).is_a?(Array)
          self.send_attempts = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @send_attempts.nil?
        invalid_properties.push('invalid value for "send_attempts", send_attempts cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['pending', 'retry', 'succeeded', 'failed'])
      return false unless status_validator.valid?(@status)
      return false if @send_attempts.nil?
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['pending', 'retry', 'succeeded', 'failed'])
    ...
    def hash
      [id, event_id, data, status, send_attempts].hash
    end
