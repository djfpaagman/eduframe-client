...
module Eduframe
  class Variant
    ...
    # How should the variant be paid by default.
    ...
    # Type of the variantable.
    attr_accessor :variantable_type

    # Unique identifier of the variantable.
    attr_accessor :variantable_id
    ...
    def self.attribute_map
      {
        ...
        :'cost' => :'cost',
        :'currency' => :'currency',
        :'variantable_type' => :'variantable_type',
        :'variantable_id' => :'variantable_id',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'variantable_type')
        self.variantable_type = attributes[:'variantable_type']
      end

      if attributes.has_key?(:'variantable_id')
        self.variantable_id = attributes[:'variantable_id']
      end
    ...
    def list_invalid_properties
      ...
      if @variantable_type.nil?
        invalid_properties.push('invalid value for "variantable_type", variantable_type cannot be nil.')
      end

      if @variantable_id.nil?
        invalid_properties.push('invalid value for "variantable_id", variantable_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @variantable_type.nil?
      return false if @variantable_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cost == o.cost &&
          currency == o.currency &&
          variantable_type == o.variantable_type &&
          variantable_id == o.variantable_id &&
    ...
    def hash
      [id, product_id, name, cost_scheme, cost, currency, variantable_type, variantable_id, created_at, updated_at, is_published, product, plugin_data].hash
    end
