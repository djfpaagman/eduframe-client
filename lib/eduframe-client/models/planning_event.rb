...
module Eduframe
  class PlanningEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'material_ids')
        if (value = attributes[:'material_ids']).is_a?(Array)
          self.material_ids = value
        end
      end
    ...
    def hash
      [id, meeting_id, meeting_location_id, name, description, material_ids, teacher_ids, start_date_time, end_date_time, meeting_location, teachers, planning_attendees, planning_meeting_locations, materials, planning_materials, meeting].hash
    end
