...
module Eduframe
  class ScheduledEmail
    ...
    # Model type of the related resource.
    attr_accessor :resource_type

    # Model identifier of the related resource.
    attr_accessor :resource_id

    # Template of the generated email.
    attr_accessor :template_id

    # Identifier of the email message
    attr_accessor :message_id

    # Perform email relative to.
    attr_accessor :relative_to

    # Perform email with relative hours.
    attr_accessor :relative_hours

    # Timestamp of when the email should be delivered.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relative_to')
        self.relative_to = attributes[:'relative_to']
      end

      if attributes.has_key?(:'relative_hours')
        self.relative_hours = attributes[:'relative_hours']
      end

      if attributes.has_key?(:'deliver_at')
    ...
    def list_invalid_properties
      ...
      if @relative_to.nil?
        invalid_properties.push('invalid value for "relative_to", relative_to cannot be nil.')
      end

      if @relative_hours.nil?
        invalid_properties.push('invalid value for "relative_hours", relative_hours cannot be nil.')
      end

      if @deliver_at.nil?
        invalid_properties.push('invalid value for "deliver_at", deliver_at cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @relative_to.nil?
      relative_to_validator = EnumAttributeValidator.new('String', ['start_date', 'end_date', 'due_date'])
      return false unless relative_to_validator.valid?(@relative_to)
      return false if @relative_hours.nil?
      return false if @deliver_at.nil?
      return false if @created_at.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] relative_to Object to be assigned
    def relative_to=(relative_to)
      validator = EnumAttributeValidator.new('String', ['start_date', 'end_date', 'due_date'])
      unless validator.valid?(relative_to)
        fail ArgumentError, 'invalid value for "relative_to", must be one of #{validator.allowable_values}.'
      end
      @relative_to = relative_to
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          relative_hours == o.relative_hours &&
    ...
    def hash
      [id, resource_type, resource_id, template_id, message_id, relative_to, relative_hours, deliver_at, created_at, template].hash
    end
