...
module Eduframe
  class Attendance
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ['attended', 'late', 'absent', 'absent_with_leave', 'blanco'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['attended', 'late', 'absent', 'absent_with_leave', 'blanco'])
    ...
    def hash
      [id, created_at, updated_at, meeting_id, enrollment_id, state, comment].hash
    end
