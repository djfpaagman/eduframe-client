...
module Eduframe
  class CalendarItem
    # Unique identifier of the calendar item.
    attr_accessor :id

    # Date and time when the calendar item is starting.
    attr_accessor :start

    # The date and time when the calendar item is ending.
    attr_accessor :_end

    # Array of identifiers of the linked resources.
    attr_accessor :resource_ids

    # Name of the calendar item.
    attr_accessor :title

    # Proposed background color of the calendar item.
    attr_accessor :background_color

    # Proposed text color of the calendar item.
    attr_accessor :text_color

    # Proposed url to go to when click on the calendar item.
    attr_accessor :url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'text_color')
      ...
      if attributes.has_key?(:'extended_props')
        self.extended_props = attributes[:'extended_props']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @extended_props.nil?
        invalid_properties.push('invalid value for "extended_props", extended_props cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @extended_props.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          url == o.url &&
          extended_props == o.extended_props
    end
    ...
    def hash
      [id, start, _end, resource_ids, title, background_color, text_color, url, extended_props].hash
    end
