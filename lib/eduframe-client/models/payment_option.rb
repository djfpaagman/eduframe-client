...
module Eduframe
  class PaymentOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'extra_cost')
        self.extra_cost = attributes[:'extra_cost']
      end
    ...
    def list_invalid_properties
      ...
      if @available_from.nil?
        invalid_properties.push('invalid value for "available_from", available_from cannot be nil.')
      end

      if @extra_cost.nil?
        invalid_properties.push('invalid value for "extra_cost", extra_cost cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @available_from.nil?
      return false if @extra_cost.nil?
    ...
    def hash
      [id, name, available_from, extra_cost, percentage, multiplier].hash
    end
