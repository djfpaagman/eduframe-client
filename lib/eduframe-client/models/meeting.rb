...
module Eduframe
  class Meeting
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'start_date_time')
      ...
      if attributes.has_key?(:'planning_events')
        if (value = attributes[:'planning_events']).is_a?(Array)
          self.planning_events = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          planning_events == o.planning_events &&
    ...
    def hash
      [id, created_at, updated_at, name, planned_course_id, start_date_time, end_date_time, meeting_location_id, teacher_ids, description, description_dashboard, teachers, planning_attendees, planning_events, planned_course, meeting_location, planning_meeting_locations, materials, planning_materials].hash
    end
