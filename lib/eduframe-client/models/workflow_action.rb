...
module Eduframe
  class WorkflowAction
    ...
    # Boolean indicating if the action enabled value can be set to false
    attr_accessor :required

    # One of the allowed action types.
    attr_accessor :type
    ...
    # Class identifier of the template.
    attr_accessor :template_type

    # Unique identifier of the connected course
    attr_accessor :course_id

    # The default value is true. When put to false the action will not create any dispatches.
    attr_accessor :enabled

    # Perform relative to (start_date, end_date, due_date).
    attr_accessor :relative_to

    # Perform with relative hours.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'model_class')
        self.model_class = attributes[:'model_class']
      end
    ...
    def list_invalid_properties
      ...
      if @model_class.nil?
        invalid_properties.push('invalid value for "model_class", model_class cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['Workflow::Actions::Email', 'Workflow::Actions::Task', 'Workflow::Actions::ScheduledEmail'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['Workflow::Actions::Email', 'Workflow::Actions::Task', 'Workflow::Actions::ScheduledEmail'])
    ...
    def hash
      [id, required, type, event, model_class, template_id, template_type, course_id, enabled, relative_to, relative_hours, template].hash
    end
