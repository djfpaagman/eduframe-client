...
module Eduframe
  class PaymentMethod
    ...
    def valid?
      ...
      gateway_validator = EnumAttributeValidator.new('String', ['Mollie', 'StripeIdeal', 'StripeAlipay', 'StripeGiropay', 'ValitorBasic', 'ValitorLoan', 'Borgun', 'StripeCheckout'])
    ...
    def gateway=(gateway)
      validator = EnumAttributeValidator.new('String', ['Mollie', 'StripeIdeal', 'StripeAlipay', 'StripeGiropay', 'ValitorBasic', 'ValitorLoan', 'Borgun', 'StripeCheckout'])
    ...
    def hash
      [id, gateway, plugin_id, name].hash
    end
