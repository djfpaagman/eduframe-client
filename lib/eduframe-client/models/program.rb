...
module Eduframe
  class Program
    ...
    attr_accessor :avatar_attachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'avatar_attachment')
        self.avatar_attachment = attributes[:'avatar_attachment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          category == o.category &&
          labels == o.labels &&
          avatar_attachment == o.avatar_attachment &&
    ...
    def hash
      [id, name, cost, cost_scheme, is_published, category_id, conditions, slug, custom, category, labels, avatar_attachment, course_tab_contents, signup_answers].hash
    end
