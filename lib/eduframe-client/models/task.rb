...
module Eduframe
  class Task
    ...
    def self.swagger_types
      {
        ...
        :'creator_id' => :'Float',
        :'completed_at' => :'String',
        :'completed_by_id' => :'Float',
        :'assigned_by_id' => :'Float',
        :'created_at' => :'String',
        :'updated_at' => :'String',
        :'name' => :'String',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'completed_by_id')
        self.completed_by_id = attributes[:'completed_by_id']
      end

      if attributes.has_key?(:'assigned_by_id')
      ...
      if attributes.has_key?(:'subject_id')
      ...
      if attributes.has_key?(:'completed_by')
    ...
    def list_invalid_properties
      ...
      if @completed_by_id.nil?
        invalid_properties.push('invalid value for "completed_by_id", completed_by_id cannot be nil.')
      end

      if @assigned_by_id.nil?
        invalid_properties.push('invalid value for "assigned_by_id", assigned_by_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @completed_by_id.nil?
      return false if @assigned_by_id.nil?
      return false if @created_at.nil?
      return false if @updated_at.nil?
      subject_type_validator = EnumAttributeValidator.new('String', ['Course', 'Account', 'User', 'Lead', 'Invoice', 'PlannedCourse', 'Order', 'Program::Edition'])
    ...
    def subject_type=(subject_type)
      validator = EnumAttributeValidator.new('String', ['Course', 'Account', 'User', 'Lead', 'Invoice', 'PlannedCourse', 'Order', 'Program::Edition'])
    ...
    def hash
      [id, creator_id, completed_at, completed_by_id, assigned_by_id, created_at, updated_at, name, description, due_date, starred, assignee_id, subject_type, subject_id, creator, assignee, completed_by].hash
    end
