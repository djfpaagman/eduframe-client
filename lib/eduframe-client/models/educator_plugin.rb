...
module Eduframe
  class EducatorPlugin
    # Unique identifier of the educator plugin.
    attr_accessor :id

    # The access token of the educator.
    ...
    attr_accessor :status_message_type

    # The status message of the educator.
    attr_accessor :status_message

    # Boolean representing the authentication status of the educator. The default authentication status is false.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'plugin_id')
        self.plugin_id = attributes[:'plugin_id']
      end

      if attributes.has_key?(:'status_message_type')
        self.status_message_type = attributes[:'status_message_type']
      end
      ...
      if attributes.has_key?(:'educator')
        self.educator = attributes[:'educator']
      end
    end
    ...
    def valid?
      ...
      status_message_type_validator = EnumAttributeValidator.new('String', ['ok', 'info', 'warning', 'danger'])
      return false unless status_message_type_validator.valid?(@status_message_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] status_message_type Object to be assigned
    def status_message_type=(status_message_type)
      validator = EnumAttributeValidator.new('String', ['ok', 'info', 'warning', 'danger'])
      unless validator.valid?(status_message_type)
        fail ArgumentError, 'invalid value for "status_message_type", must be one of #{validator.allowable_values}.'
      end
      @status_message_type = status_message_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status_message_type == o.status_message_type &&
    ...
    def hash
      [id, access_token, plugin_id, status_message_type, status_message, authenticated, plugin, educator].hash
    end
