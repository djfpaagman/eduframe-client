...
module Eduframe
  class ProgramEnrollment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edition_id')
      ...
      if attributes.has_key?(:'graduation')
        self.graduation = attributes[:'graduation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @edition_id.nil?
        invalid_properties.push('invalid value for "edition_id", edition_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @edition_id.nil?
      return false if @order_id.nil?
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ['confirmed', 'canceled'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['confirmed', 'canceled'])
    ...
    def hash
      [id, student_id, edition_id, order_id, state, blocks, student, order, edition, graduation].hash
    end
