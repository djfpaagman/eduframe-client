...
module Eduframe
  class PlanningEventTemplate
    # Unique identifier of the planning event template
    attr_accessor :id

    # Identifier of the meeting template
    attr_accessor :meeting_template_id

    # Name of the event
    attr_accessor :name

    # Time when the event is starting
    attr_accessor :start_time

    # Time when the event is ending
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'meeting_template_id')
        self.meeting_template_id = attributes[:'meeting_template_id']
      end
    ...
    def list_invalid_properties
      ...
      if @meeting_template_id.nil?
        invalid_properties.push('invalid value for "meeting_template_id", meeting_template_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @meeting_template_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          meeting_template_id == o.meeting_template_id &&
          name == o.name &&
    ...
    def hash
      [id, meeting_template_id, name, start_time, end_time, planning_attendees, planning_materials, planning_meeting_locations].hash
    end
