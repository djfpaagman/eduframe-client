...
module Eduframe
  class MeetingSchedule
    ...
    def hash
      [id, created_at, updated_at, name, planned_course_id, start_date_time, end_date_time, meeting_location_id, teacher_ids, description, description_dashboard, planning_attendees, planning_materials].hash
    end
