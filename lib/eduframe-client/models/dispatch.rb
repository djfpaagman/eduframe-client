...
module Eduframe
  class Dispatch
    ...
    # Model type of the generated dispatchable (task / email / ...).
    attr_accessor :dispatchable_type

    # Model identifier of the generated dispatchable (task / email / ...).
    attr_accessor :dispatchable_id

    # State of the dispatch.
    attr_accessor :state

    # Timestamp of when the dispatch was performed.
    ...
    def self.attribute_map
      {
        ...
        :'dispatchable_type' => :'dispatchable_type',
        :'dispatchable_id' => :'dispatchable_id',
        :'state' => :'state',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dispatchable_type')
        self.dispatchable_type = attributes[:'dispatchable_type']
      end

      if attributes.has_key?(:'dispatchable_id')
        self.dispatchable_id = attributes[:'dispatchable_id']
      end
      ...
      if attributes.has_key?(:'performed_at')
    ...
    def list_invalid_properties
      ...
      if @dispatchable_type.nil?
        invalid_properties.push('invalid value for "dispatchable_type", dispatchable_type cannot be nil.')
      end

      if @dispatchable_id.nil?
        invalid_properties.push('invalid value for "dispatchable_id", dispatchable_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dispatchable_type.nil?
      return false if @dispatchable_id.nil?
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ['enqueued', 'succeeded', 'failed', 'skipped'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['enqueued', 'succeeded', 'failed', 'skipped'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dispatchable_type == o.dispatchable_type &&
          dispatchable_id == o.dispatchable_id &&
          state == o.state &&
    ...
    def hash
      [id, resource_type, resource_id, dispatchable_type, dispatchable_id, state, performed_at, created_at].hash
    end
