...
module Eduframe
  class Graduation
    # Unique identifier of the graduation
    attr_accessor :id
    ...
    # Graduation state, default is awaiting judgement
    attr_accessor :state
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ['awaiting_judgement', 'passed', 'failed'])
    ...
    def hash
      [id, created_at, updated_at, state].hash
    end
