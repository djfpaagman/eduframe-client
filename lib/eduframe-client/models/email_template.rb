...
module Eduframe
  class EmailTemplate
    ...
    # The class of the associated model. - Email::Template
    attr_accessor :model_class

    # From field of the email. The default is the educator reply to email. - Email::Template
    attr_accessor :from

    # Title that identifies the email template. - Email::Template
    attr_accessor :title

    # To field of the email. - Email::Template
    attr_accessor :to

    # Subject of for the email. - Email::Template
    attr_accessor :subject

    # Body field of the email. - Email::Template
    attr_accessor :body

    # Bcc field of the email. - Email::Template
    attr_accessor :bcc

    # Array of strings that show the path to the attachment. The default value is an empty array. - Email::Template
    ...
    def hash
      [id, model_class, from, title, to, subject, body, bcc, attachments, actions].hash
    end
