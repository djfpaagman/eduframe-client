...
module Eduframe
  class InvoiceItem
    ...
    attr_accessor :invoice_vat_id

    # Set if you want to delete this item.
    attr_accessor :_destroy

    attr_accessor :invoice_vat
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invoice_vat_id')
        self.invoice_vat_id = attributes[:'invoice_vat_id']
      end

      if attributes.has_key?(:'_destroy')
        self._destroy = attributes[:'_destroy']
      end

      if attributes.has_key?(:'invoice_vat')
        self.invoice_vat = attributes[:'invoice_vat']
      end
    ...
    def list_invalid_properties
      ...
      if @catalog_variant_id.nil?
        invalid_properties.push('invalid value for "catalog_variant_id", catalog_variant_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @catalog_variant_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          invoice_vat_id == o.invoice_vat_id &&
          _destroy == o._destroy &&
          invoice_vat == o.invoice_vat &&
    ...
    def hash
      [id, catalog_variant_id, created_at, updated_at, units, unit_price, name, invoice_vat_id, _destroy, invoice_vat, plugin_data].hash
    end
