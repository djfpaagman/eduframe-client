...
module Eduframe
  class User
    ...
    attr_accessor :teacher_headline

    # Long description of the user. (same as description)
    attr_accessor :teacher_description

    # Short note about the user.
    attr_accessor :notes_user
    ...
    # Number of assigned planned courses as a teacher.
    attr_accessor :teacher_enrollments_count
    ...
    attr_accessor :with_authentication
    ...
    def self.swagger_types
      {
        ...
        :'teacher_enrollments_count' => :'Float',
        :'first_name' => :'String',
        :'middle_name' => :'String',
        :'last_name' => :'String',
        :'email' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teacher_headline')
        self.teacher_headline = attributes[:'teacher_headline']
      end

      if attributes.has_key?(:'teacher_description')
        self.teacher_description = attributes[:'teacher_description']
      end

      if attributes.has_key?(:'notes_user')
        self.notes_user = attributes[:'notes_user']
      end
      ...
      if attributes.has_key?(:'employee_number')
        self.employee_number = attributes[:'employee_number']
      end

      if attributes.has_key?(:'teacher_enrollments_count')
        self.teacher_enrollments_count = attributes[:'teacher_enrollments_count']
      end
      ...
      if attributes.has_key?(:'with_authentication')
        self.with_authentication = attributes[:'with_authentication']
      end
    ...
    def list_invalid_properties
      ...
      if @teacher_headline.nil?
        invalid_properties.push('invalid value for "teacher_headline", teacher_headline cannot be nil.')
      end

      if @teacher_description.nil?
        invalid_properties.push('invalid value for "teacher_description", teacher_description cannot be nil.')
      end

      if @notes_user.nil?
        invalid_properties.push('invalid value for "notes_user", notes_user cannot be nil.')
      end
      ...
      if @teacher_enrollments_count.nil?
        invalid_properties.push('invalid value for "teacher_enrollments_count", teacher_enrollments_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @teacher_headline.nil?
      return false if @teacher_description.nil?
      return false if @notes_user.nil?
      return false if @description.nil?
      return false if @employee_number.nil?
      return false if @teacher_enrollments_count.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          teacher_headline == o.teacher_headline &&
          teacher_description == o.teacher_description &&
          notes_user == o.notes_user &&
          description == o.description &&
          employee_number == o.employee_number &&
          teacher_enrollments_count == o.teacher_enrollments_count &&
          first_name == o.first_name &&
          middle_name == o.middle_name &&
          last_name == o.last_name &&
          email == o.email &&
          wants_newsletter == o.wants_newsletter &&
          with_authentication == o.with_authentication &&
          labels == o.labels
    end
    ...
    def hash
      [id, slug, avatar_url, roles, created_at, updated_at, teacher_headline, teacher_description, notes_user, description, employee_number, teacher_enrollments_count, first_name, middle_name, last_name, email, wants_newsletter, with_authentication, labels].hash
    end
