...
# Unit tests for Eduframe::CourseTab
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseTab' do
  before do
    # run before each test
    @instance = Eduframe::CourseTab.new
  end
  ...
  describe 'test an instance of CourseTab' do
    it 'should create an instance of CourseTab' do
      expect(@instance).to be_instance_of(Eduframe::CourseTab)
    end
  end
