...
# Unit tests for Eduframe::PlanningEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningEvent' do
  before do
    # run before each test
    @instance = Eduframe::PlanningEvent.new
  end
  ...
  describe 'test an instance of PlanningEvent' do
    it 'should create an instance of PlanningEvent' do
      expect(@instance).to be_instance_of(Eduframe::PlanningEvent)
    end
  end
