...
# Unit tests for Eduframe::Grade
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Grade' do
  before do
    # run before each test
    @instance = Eduframe::Grade.new
  end
  ...
  describe 'test an instance of Grade' do
    it 'should create an instance of Grade' do
      expect(@instance).to be_instance_of(Eduframe::Grade)
    end
  end
  ...
  describe 'test attribute "gradeable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "gradeable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
