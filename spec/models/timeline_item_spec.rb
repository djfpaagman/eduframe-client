...
# Unit tests for Eduframe::TimelineItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineItem' do
  before do
    # run before each test
    @instance = Eduframe::TimelineItem.new
  end
  ...
  describe 'test an instance of TimelineItem' do
    it 'should create an instance of TimelineItem' do
      expect(@instance).to be_instance_of(Eduframe::TimelineItem)
    end
  end
