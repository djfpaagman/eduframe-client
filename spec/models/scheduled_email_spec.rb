...
# Unit tests for Eduframe::ScheduledEmail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduledEmail' do
  before do
    # run before each test
    @instance = Eduframe::ScheduledEmail.new
  end
  ...
  describe 'test an instance of ScheduledEmail' do
    it 'should create an instance of ScheduledEmail' do
      expect(@instance).to be_instance_of(Eduframe::ScheduledEmail)
    end
  end
  ...
  describe 'test attribute "relative_to"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["start_date", "end_date", "due_date"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.relative_to = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "relative_hours"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
