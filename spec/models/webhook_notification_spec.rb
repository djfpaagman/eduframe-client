...
# Unit tests for Eduframe::WebhookNotification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookNotification' do
  before do
    # run before each test
    @instance = Eduframe::WebhookNotification.new
  end
  ...
  describe 'test an instance of WebhookNotification' do
    it 'should create an instance of WebhookNotification' do
      expect(@instance).to be_instance_of(Eduframe::WebhookNotification)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "retry", "succeeded", "failed"])
