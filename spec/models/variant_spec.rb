...
# Unit tests for Eduframe::Variant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Variant' do
  before do
    # run before each test
    @instance = Eduframe::Variant.new
  end
  ...
  describe 'test an instance of Variant' do
    it 'should create an instance of Variant' do
      expect(@instance).to be_instance_of(Eduframe::Variant)
    end
  end
  ...
  describe 'test attribute "variantable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "variantable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
