...
# Unit tests for Eduframe::Authentication
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Authentication' do
  before do
    # run before each test
    @instance = Eduframe::Authentication.new
  end
  ...
  describe 'test an instance of Authentication' do
    it 'should create an instance of Authentication' do
      expect(@instance).to be_instance_of(Eduframe::Authentication)
    end
  end
  ...
  describe 'test attribute "authentication_provider_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
