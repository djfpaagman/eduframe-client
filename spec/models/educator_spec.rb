...
# Unit tests for Eduframe::Educator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Educator' do
  before do
    # run before each test
    @instance = Eduframe::Educator.new
  end
  ...
  describe 'test an instance of Educator' do
    it 'should create an instance of Educator' do
      expect(@instance).to be_instance_of(Eduframe::Educator)
    end
  end
  ...
  describe 'test attribute "standard_planning_text"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "default_invoice_vat_multiplier"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "signup_default_account_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["personal", "business"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.signup_default_account_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "signup_contact_info"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "educator_plugins"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plugin_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
