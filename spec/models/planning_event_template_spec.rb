...
# Unit tests for Eduframe::PlanningEventTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningEventTemplate' do
  before do
    # run before each test
    @instance = Eduframe::PlanningEventTemplate.new
  end
  ...
  describe 'test an instance of PlanningEventTemplate' do
    it 'should create an instance of PlanningEventTemplate' do
      expect(@instance).to be_instance_of(Eduframe::PlanningEventTemplate)
    end
  end
  ...
  describe 'test attribute "meeting_template_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
