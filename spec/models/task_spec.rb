...
# Unit tests for Eduframe::Task
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Task' do
  before do
    # run before each test
    @instance = Eduframe::Task.new
  end
  ...
  describe 'test an instance of Task' do
    it 'should create an instance of Task' do
      expect(@instance).to be_instance_of(Eduframe::Task)
    end
  end
  ...
  describe 'test attribute "subject_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Course", "Account", "User", "Lead", "Invoice", "PlannedCourse", "Order", "Program::Edition"])
