...
# Unit tests for Eduframe::SignupQuestion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignupQuestion' do
  before do
    # run before each test
    @instance = Eduframe::SignupQuestion.new
  end
  ...
  describe 'test an instance of SignupQuestion' do
    it 'should create an instance of SignupQuestion' do
      expect(@instance).to be_instance_of(Eduframe::SignupQuestion)
    end
  end
  ...
  describe 'test attribute "field_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["boolean", "datepicker", "decimal", "phone", "select", "multiselect", "string", "text", "vat_number"])
  ...
  describe 'test attribute "for_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["user", "teacher", "account", "catalog_product", "order"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.for_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "for_student"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "for_customer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "use_as_duplicate_indicator"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
