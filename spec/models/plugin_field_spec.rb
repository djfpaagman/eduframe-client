...
# Unit tests for Eduframe::PluginField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginField' do
  before do
    # run before each test
    @instance = Eduframe::PluginField.new
  end
  ...
  describe 'test an instance of PluginField' do
    it 'should create an instance of PluginField' do
      expect(@instance).to be_instance_of(Eduframe::PluginField)
    end
  end
  ...
  describe 'test attribute "data_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["integer", "string", "date", "table", "boolean"])
