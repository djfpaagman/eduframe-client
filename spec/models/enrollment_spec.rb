...
# Unit tests for Eduframe::Enrollment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Enrollment' do
  before do
    # run before each test
    @instance = Eduframe::Enrollment.new
  end
  ...
  describe 'test an instance of Enrollment' do
    it 'should create an instance of Enrollment' do
      expect(@instance).to be_instance_of(Eduframe::Enrollment)
    end
  end
  ...
  describe 'test attribute "planned_course_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["confirmed", "active", "canceled", "completed"])
  ...
  describe 'test attribute "graduation_state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["awaiting_judgement", "passed", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.graduation_state = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "may_award_certificate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "may_award_credits"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "planned_course"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
