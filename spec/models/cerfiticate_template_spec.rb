...
# Unit tests for Eduframe::CerfiticateTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CerfiticateTemplate' do
  before do
    # run before each test
    @instance = Eduframe::CerfiticateTemplate.new
  end
  ...
  describe 'test an instance of CerfiticateTemplate' do
    it 'should create an instance of CerfiticateTemplate' do
      expect(@instance).to be_instance_of(Eduframe::CerfiticateTemplate)
    end
  end
