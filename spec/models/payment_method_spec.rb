...
# Unit tests for Eduframe::PaymentMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethod' do
  before do
    # run before each test
    @instance = Eduframe::PaymentMethod.new
  end
  ...
  describe 'test an instance of PaymentMethod' do
    it 'should create an instance of PaymentMethod' do
      expect(@instance).to be_instance_of(Eduframe::PaymentMethod)
    end
  end
  ...
  describe 'test attribute "gateway"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Mollie", "StripeIdeal", "StripeAlipay", "StripeGiropay", "ValitorBasic", "ValitorLoan", "Borgun", "StripeCheckout"])
