...
# Unit tests for Eduframe::EducatorPlugin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EducatorPlugin' do
  before do
    # run before each test
    @instance = Eduframe::EducatorPlugin.new
  end
  ...
  describe 'test an instance of EducatorPlugin' do
    it 'should create an instance of EducatorPlugin' do
      expect(@instance).to be_instance_of(Eduframe::EducatorPlugin)
    end
  end
  ...
  describe 'test attribute "status_message_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "info", "warning", "danger"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.status_message_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "educator"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
