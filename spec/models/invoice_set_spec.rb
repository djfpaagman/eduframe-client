...
# Unit tests for Eduframe::InvoiceSet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceSet' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceSet.new
  end
  ...
  describe 'test an instance of InvoiceSet' do
    it 'should create an instance of InvoiceSet' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceSet)
    end
  end
