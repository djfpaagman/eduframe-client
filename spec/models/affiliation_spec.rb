...
# Unit tests for Eduframe::Affiliation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Affiliation' do
  before do
    # run before each test
    @instance = Eduframe::Affiliation.new
  end
  ...
  describe 'test an instance of Affiliation' do
    it 'should create an instance of Affiliation' do
      expect(@instance).to be_instance_of(Eduframe::Affiliation)
    end
  end
  ...
  describe 'test attribute "key_contact"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
