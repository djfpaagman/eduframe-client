...
# Unit tests for Eduframe::CalendarResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CalendarResource' do
  before do
    # run before each test
    @instance = Eduframe::CalendarResource.new
  end
  ...
  describe 'test an instance of CalendarResource' do
    it 'should create an instance of CalendarResource' do
      expect(@instance).to be_instance_of(Eduframe::CalendarResource)
    end
  end
