...
# Unit tests for Eduframe::MaterialGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaterialGroup' do
  before do
    # run before each test
    @instance = Eduframe::MaterialGroup.new
  end
  ...
  describe 'test an instance of MaterialGroup' do
    it 'should create an instance of MaterialGroup' do
      expect(@instance).to be_instance_of(Eduframe::MaterialGroup)
    end
  end
