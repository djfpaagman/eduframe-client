...
# Unit tests for Eduframe::MeetingLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingLocation' do
  before do
    # run before each test
    @instance = Eduframe::MeetingLocation.new
  end
  ...
  describe 'test an instance of MeetingLocation' do
    it 'should create an instance of MeetingLocation' do
      expect(@instance).to be_instance_of(Eduframe::MeetingLocation)
    end
  end
