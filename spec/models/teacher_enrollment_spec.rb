...
# Unit tests for Eduframe::TeacherEnrollment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeacherEnrollment' do
  before do
    # run before each test
    @instance = Eduframe::TeacherEnrollment.new
  end
  ...
  describe 'test an instance of TeacherEnrollment' do
    it 'should create an instance of TeacherEnrollment' do
      expect(@instance).to be_instance_of(Eduframe::TeacherEnrollment)
    end
  end
  ...
  describe 'test attribute "teacher_role_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "teacher_role"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
