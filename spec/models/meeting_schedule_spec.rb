...
# Unit tests for Eduframe::MeetingSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingSchedule' do
  before do
    # run before each test
    @instance = Eduframe::MeetingSchedule.new
  end
  ...
  describe 'test an instance of MeetingSchedule' do
    it 'should create an instance of MeetingSchedule' do
      expect(@instance).to be_instance_of(Eduframe::MeetingSchedule)
    end
  end
