...
# Unit tests for Eduframe::Edition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Edition' do
  before do
    # run before each test
    @instance = Eduframe::Edition.new
  end
  ...
  describe 'test an instance of Edition' do
    it 'should create an instance of Edition' do
      expect(@instance).to be_instance_of(Eduframe::Edition)
    end
  end
