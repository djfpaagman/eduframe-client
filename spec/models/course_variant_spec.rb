...
# Unit tests for Eduframe::CourseVariant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseVariant' do
  before do
    # run before each test
    @instance = Eduframe::CourseVariant.new
  end
  ...
  describe 'test an instance of CourseVariant' do
    it 'should create an instance of CourseVariant' do
      expect(@instance).to be_instance_of(Eduframe::CourseVariant)
    end
  end
