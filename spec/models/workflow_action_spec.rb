...
# Unit tests for Eduframe::WorkflowAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkflowAction' do
  before do
    # run before each test
    @instance = Eduframe::WorkflowAction.new
  end
  ...
  describe 'test an instance of WorkflowAction' do
    it 'should create an instance of WorkflowAction' do
      expect(@instance).to be_instance_of(Eduframe::WorkflowAction)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Workflow::Actions::Email", "Workflow::Actions::Task", "Workflow::Actions::ScheduledEmail"])
  ...
  describe 'test attribute "model_class"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
