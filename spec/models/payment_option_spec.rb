...
# Unit tests for Eduframe::PaymentOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentOption' do
  before do
    # run before each test
    @instance = Eduframe::PaymentOption.new
  end
  ...
  describe 'test an instance of PaymentOption' do
    it 'should create an instance of PaymentOption' do
      expect(@instance).to be_instance_of(Eduframe::PaymentOption)
    end
  end
  ...
  describe 'test attribute "extra_cost"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
