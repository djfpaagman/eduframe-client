...
# Unit tests for Eduframe::ProgramEnrollment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramEnrollment' do
  before do
    # run before each test
    @instance = Eduframe::ProgramEnrollment.new
  end
  ...
  describe 'test an instance of ProgramEnrollment' do
    it 'should create an instance of ProgramEnrollment' do
      expect(@instance).to be_instance_of(Eduframe::ProgramEnrollment)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["confirmed", "canceled"])
  ...
  describe 'test attribute "graduation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
