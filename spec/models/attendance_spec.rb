...
# Unit tests for Eduframe::Attendance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Attendance' do
  before do
    # run before each test
    @instance = Eduframe::Attendance.new
  end
  ...
  describe 'test an instance of Attendance' do
    it 'should create an instance of Attendance' do
      expect(@instance).to be_instance_of(Eduframe::Attendance)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["attended", "late", "absent", "absent_with_leave", "blanco"])
