...
# Unit tests for Eduframe::InvoiceVat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceVat' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceVat.new
  end
  ...
  describe 'test an instance of InvoiceVat' do
    it 'should create an instance of InvoiceVat' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceVat)
    end
  end
