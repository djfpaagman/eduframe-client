...
# Unit tests for Eduframe::CalendarItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CalendarItem' do
  before do
    # run before each test
    @instance = Eduframe::CalendarItem.new
  end
  ...
  describe 'test an instance of CalendarItem' do
    it 'should create an instance of CalendarItem' do
      expect(@instance).to be_instance_of(Eduframe::CalendarItem)
    end
  end
  ...
  describe 'test attribute "extended_props"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
