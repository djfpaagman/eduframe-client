...
# Unit tests for Eduframe::CreditDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditDefinition' do
  before do
    # run before each test
    @instance = Eduframe::CreditDefinition.new
  end
  ...
  describe 'test an instance of CreditDefinition' do
    it 'should create an instance of CreditDefinition' do
      expect(@instance).to be_instance_of(Eduframe::CreditDefinition)
    end
  end
