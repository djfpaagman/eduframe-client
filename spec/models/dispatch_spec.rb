...
# Unit tests for Eduframe::Dispatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dispatch' do
  before do
    # run before each test
    @instance = Eduframe::Dispatch.new
  end
  ...
  describe 'test an instance of Dispatch' do
    it 'should create an instance of Dispatch' do
      expect(@instance).to be_instance_of(Eduframe::Dispatch)
    end
  end
  ...
  describe 'test attribute "dispatchable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dispatchable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["enqueued", "succeeded", "failed", "skipped"])
