...
# Unit tests for Eduframe::TeacherAttendee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeacherAttendee' do
  before do
    # run before each test
    @instance = Eduframe::TeacherAttendee.new
  end
  ...
  describe 'test an instance of TeacherAttendee' do
    it 'should create an instance of TeacherAttendee' do
      expect(@instance).to be_instance_of(Eduframe::TeacherAttendee)
    end
  end
