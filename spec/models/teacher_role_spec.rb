...
# Unit tests for Eduframe::TeacherRole
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeacherRole' do
  before do
    # run before each test
    @instance = Eduframe::TeacherRole.new
  end
  ...
  describe 'test an instance of TeacherRole' do
    it 'should create an instance of TeacherRole' do
      expect(@instance).to be_instance_of(Eduframe::TeacherRole)
    end
  end
