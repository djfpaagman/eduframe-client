...
# Unit tests for Eduframe::Graduation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Graduation' do
  before do
    # run before each test
    @instance = Eduframe::Graduation.new
  end
  ...
  describe 'test an instance of Graduation' do
    it 'should create an instance of Graduation' do
      expect(@instance).to be_instance_of(Eduframe::Graduation)
    end
  end
