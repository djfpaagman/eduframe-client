...
# Unit tests for Eduframe::CourseLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseLocation' do
  before do
    # run before each test
    @instance = Eduframe::CourseLocation.new
  end
  ...
  describe 'test an instance of CourseLocation' do
    it 'should create an instance of CourseLocation' do
      expect(@instance).to be_instance_of(Eduframe::CourseLocation)
    end
  end
  ...
  describe 'test attribute "meeting_locations"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
