...
# Unit tests for Eduframe::Meeting
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Meeting' do
  before do
    # run before each test
    @instance = Eduframe::Meeting.new
  end
  ...
  describe 'test an instance of Meeting' do
    it 'should create an instance of Meeting' do
      expect(@instance).to be_instance_of(Eduframe::Meeting)
    end
  end
  ...
  describe 'test attribute "planning_events"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
