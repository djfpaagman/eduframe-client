...
# Unit tests for Eduframe::BatchError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchError' do
  before do
    # run before each test
    @instance = Eduframe::BatchError.new
  end
  ...
  describe 'test an instance of BatchError' do
    it 'should create an instance of BatchError' do
      expect(@instance).to be_instance_of(Eduframe::BatchError)
    end
  end
