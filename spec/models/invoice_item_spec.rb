...
# Unit tests for Eduframe::InvoiceItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceItem' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceItem.new
  end
  ...
  describe 'test an instance of InvoiceItem' do
    it 'should create an instance of InvoiceItem' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceItem)
    end
  end
  ...
  describe 'test attribute "invoice_vat_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "_destroy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "invoice_vat"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
