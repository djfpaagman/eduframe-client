...
# Unit tests for Eduframe::CalendarEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CalendarEvent' do
  before do
    # run before each test
    @instance = Eduframe::CalendarEvent.new
  end
  ...
  describe 'test an instance of CalendarEvent' do
    it 'should create an instance of CalendarEvent' do
      expect(@instance).to be_instance_of(Eduframe::CalendarEvent)
    end
  end
  ...
  describe 'test attribute "meeting_location_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "calendar_booking"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
