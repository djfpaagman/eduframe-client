...
# Unit tests for Eduframe::DuplicateUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DuplicateUser' do
  before do
    # run before each test
    @instance = Eduframe::DuplicateUser.new
  end
  ...
  describe 'test an instance of DuplicateUser' do
    it 'should create an instance of DuplicateUser' do
      expect(@instance).to be_instance_of(Eduframe::DuplicateUser)
    end
  end
  ...
  describe 'test attribute "duplicate_user_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "duplicate_user"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
