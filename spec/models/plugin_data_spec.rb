...
# Unit tests for Eduframe::PluginData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginData' do
  before do
    # run before each test
    @instance = Eduframe::PluginData.new
  end
  ...
  describe 'test an instance of PluginData' do
    it 'should create an instance of PluginData' do
      expect(@instance).to be_instance_of(Eduframe::PluginData)
    end
  end
