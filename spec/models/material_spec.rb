...
# Unit tests for Eduframe::Material
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Material' do
  before do
    # run before each test
    @instance = Eduframe::Material.new
  end
  ...
  describe 'test an instance of Material' do
    it 'should create an instance of Material' do
      expect(@instance).to be_instance_of(Eduframe::Material)
    end
  end
  ...
  describe 'test attribute "material_group_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "material_group"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
