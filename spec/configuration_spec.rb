...
describe Eduframe::Configuration do
  let(:config) { Eduframe::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://api.eduframe.nl/api/v1")
    # Eduframe.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://api.eduframe.nl/api/v1")
    end
