...
# Unit tests for Eduframe::CreditCategoriesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditCategoriesApi' do
  before do
    # run before each test
    @instance = Eduframe::CreditCategoriesApi.new
  end
  ...
  describe 'test an instance of CreditCategoriesApi' do
    it 'should create an instance of CreditCategoriesApi' do
      expect(@instance).to be_instance_of(Eduframe::CreditCategoriesApi)
    end
  end

  # unit tests for get_credit_categories
  # Get all credit category records
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Array<String>] :include Include relations
  # @return [Array<CreditCategory>]
  describe 'get_credit_categories test' do
    it 'should work' do
