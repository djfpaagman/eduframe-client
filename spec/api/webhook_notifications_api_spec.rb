...
# Unit tests for Eduframe::WebhookNotificationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookNotificationsApi' do
  before do
    # run before each test
    @instance = Eduframe::WebhookNotificationsApi.new
  end
  ...
  describe 'test an instance of WebhookNotificationsApi' do
    it 'should create an instance of WebhookNotificationsApi' do
      expect(@instance).to be_instance_of(Eduframe::WebhookNotificationsApi)
    end
  end

  # unit tests for get_webhooks_webhook_id_notifications
  # Get the notifications for a specific webhook
  # 
  # @param webhook_id 
  # @param [Hash] opts the optional parameters
  # @return [Array<WebhookNotification>]
  describe 'get_webhooks_webhook_id_notifications test' do
    it 'should work' do
