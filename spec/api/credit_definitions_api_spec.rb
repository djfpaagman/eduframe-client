...
# Unit tests for Eduframe::CreditDefinitionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditDefinitionsApi' do
  before do
    # run before each test
    @instance = Eduframe::CreditDefinitionsApi.new
  end
  ...
  describe 'test an instance of CreditDefinitionsApi' do
    it 'should create an instance of CreditDefinitionsApi' do
      expect(@instance).to be_instance_of(Eduframe::CreditDefinitionsApi)
    end
  end

  # unit tests for get_courses_course_id_credit_definitions
  ...
  describe 'get_courses_course_id_credit_definitions test' do
    it 'should work' do
