...
# Unit tests for Eduframe::TeachersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeachersApi' do
  before do
    # run before each test
    @instance = Eduframe::TeachersApi.new
  end
  ...
  describe 'test an instance of TeachersApi' do
    it 'should create an instance of TeachersApi' do
      expect(@instance).to be_instance_of(Eduframe::TeachersApi)
    end
  end
  ...
  # unit tests for get_teachers_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [User]
  describe 'get_teachers_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
