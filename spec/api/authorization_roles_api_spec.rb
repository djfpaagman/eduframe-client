...
# Unit tests for Eduframe::AuthorizationRolesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationRolesApi' do
  before do
    # run before each test
    @instance = Eduframe::AuthorizationRolesApi.new
  end
  ...
  describe 'test an instance of AuthorizationRolesApi' do
    it 'should create an instance of AuthorizationRolesApi' do
      expect(@instance).to be_instance_of(Eduframe::AuthorizationRolesApi)
    end
  end

  # unit tests for get_authorization_roles
  # Get all roles
  # 
  # @param [Hash] opts the optional parameters
  # @return [Array<Role>]
  describe 'get_authorization_roles test' do
    it 'should work' do
