...
# Unit tests for Eduframe::CourseVariantsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseVariantsApi' do
  before do
    # run before each test
    @instance = Eduframe::CourseVariantsApi.new
  end
  ...
  describe 'test an instance of CourseVariantsApi' do
    it 'should create an instance of CourseVariantsApi' do
      expect(@instance).to be_instance_of(Eduframe::CourseVariantsApi)
    end
  end

  # unit tests for get_course_variants
  ...
  describe 'get_course_variants test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_course_variants_id
  # Get a course variant record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [CourseVariant]
  describe 'get_course_variants_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_course_variants
  # Create a course variant
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [CourseVariant]
  describe 'post_course_variants test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
