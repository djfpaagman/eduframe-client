...
# Unit tests for Eduframe::PaymentOptionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentOptionsApi' do
  before do
    # run before each test
    @instance = Eduframe::PaymentOptionsApi.new
  end
  ...
  describe 'test an instance of PaymentOptionsApi' do
    it 'should create an instance of PaymentOptionsApi' do
      expect(@instance).to be_instance_of(Eduframe::PaymentOptionsApi)
    end
  end
