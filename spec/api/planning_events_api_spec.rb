...
# Unit tests for Eduframe::PlanningEventsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningEventsApi' do
  before do
    # run before each test
    @instance = Eduframe::PlanningEventsApi.new
  end
  ...
  describe 'test an instance of PlanningEventsApi' do
    it 'should create an instance of PlanningEventsApi' do
      expect(@instance).to be_instance_of(Eduframe::PlanningEventsApi)
    end
  end

  # unit tests for delete_planning_events_id
  # Delete a planning event.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [PlanningEvent]
  describe 'delete_planning_events_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planning_events
  ...
  describe 'get_planning_events test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planning_events_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [PlanningEvent]
  describe 'get_planning_events_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_planning_events
  # Create a planning event
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [PlanningEvent]
  describe 'post_planning_events test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_planning_events_id
  ...
  # @option opts [Body] :body 
  # @return [PlanningEvent]
  describe 'put_planning_events_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
