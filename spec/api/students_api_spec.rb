...
# Unit tests for Eduframe::StudentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StudentsApi' do
  before do
    # run before each test
    @instance = Eduframe::StudentsApi.new
  end
  ...
  describe 'test an instance of StudentsApi' do
    it 'should create an instance of StudentsApi' do
      expect(@instance).to be_instance_of(Eduframe::StudentsApi)
    end
  end
  ...
  # unit tests for get_students_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [User]
  describe 'get_students_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
