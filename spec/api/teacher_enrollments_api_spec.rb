...
# Unit tests for Eduframe::TeacherEnrollmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeacherEnrollmentsApi' do
  before do
    # run before each test
    @instance = Eduframe::TeacherEnrollmentsApi.new
  end
  ...
  describe 'test an instance of TeacherEnrollmentsApi' do
    it 'should create an instance of TeacherEnrollmentsApi' do
      expect(@instance).to be_instance_of(Eduframe::TeacherEnrollmentsApi)
    end
  end

  # unit tests for delete_teacher_enrollments_id
  # Delete a teacher enrollment.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [TeacherEnrollment]
  describe 'delete_teacher_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planned_courses_planned_course_id_teacher_enrollments
  ...
  describe 'get_planned_courses_planned_course_id_teacher_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_teacher_enrollments
  ...
  # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
  # @return [Array<TeacherEnrollment>]
  describe 'get_teacher_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_planned_courses_planned_course_id_teacher_enrollments
  ...
  # @return [TeacherEnrollment]
  describe 'post_planned_courses_planned_course_id_teacher_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_teacher_enrollments
  # Enroll a teacher to a planned_course.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [TeacherEnrollment]
  describe 'post_teacher_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_teacher_enrollments_id
  ...
  # @option opts [Body] :body 
  # @return [TeacherEnrollment]
  describe 'put_teacher_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
