...
# Unit tests for Eduframe::SignupApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignupApi' do
  before do
    # run before each test
    @instance = Eduframe::SignupApi.new
  end
  ...
  describe 'test an instance of SignupApi' do
    it 'should create an instance of SignupApi' do
      expect(@instance).to be_instance_of(Eduframe::SignupApi)
    end
  end

  # unit tests for post_signup
  # Perform a signup.
