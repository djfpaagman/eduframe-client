...
# Unit tests for Eduframe::CustomersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomersApi' do
  before do
    # run before each test
    @instance = Eduframe::CustomersApi.new
  end
  ...
  describe 'test an instance of CustomersApi' do
    it 'should create an instance of CustomersApi' do
      expect(@instance).to be_instance_of(Eduframe::CustomersApi)
    end
  end
  ...
  # unit tests for get_customers_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [User]
  describe 'get_customers_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
