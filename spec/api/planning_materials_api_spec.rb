...
# Unit tests for Eduframe::PlanningMaterialsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningMaterialsApi' do
  before do
    # run before each test
    @instance = Eduframe::PlanningMaterialsApi.new
  end
  ...
  describe 'test an instance of PlanningMaterialsApi' do
    it 'should create an instance of PlanningMaterialsApi' do
      expect(@instance).to be_instance_of(Eduframe::PlanningMaterialsApi)
    end
  end

  # unit tests for get_planning_materials
  ...
  describe 'get_planning_materials test' do
    it 'should work' do
