...
# Unit tests for Eduframe::ProgramBlocksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramBlocksApi' do
  before do
    # run before each test
    @instance = Eduframe::ProgramBlocksApi.new
  end
  ...
  describe 'test an instance of ProgramBlocksApi' do
    it 'should create an instance of ProgramBlocksApi' do
      expect(@instance).to be_instance_of(Eduframe::ProgramBlocksApi)
    end
  end

  # unit tests for delete_program_blocks_id
  # Delete a program block
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Block]
  describe 'delete_program_blocks_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_blocks
  ...
  # @return [Array<Block>]
  describe 'get_program_blocks test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_program_blocks
  # Create a program block
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Block]
  describe 'post_program_blocks test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_program_blocks_id
  ...
  # @option opts [Body] :body 
  # @return [Block]
  describe 'put_program_blocks_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
