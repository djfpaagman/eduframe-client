...
# Unit tests for Eduframe::CatalogVariantsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogVariantsApi' do
  before do
    # run before each test
    @instance = Eduframe::CatalogVariantsApi.new
  end
  ...
  describe 'test an instance of CatalogVariantsApi' do
    it 'should create an instance of CatalogVariantsApi' do
      expect(@instance).to be_instance_of(Eduframe::CatalogVariantsApi)
    end
  end
  ...
  # unit tests for get_catalog_variants_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Variant]
  describe 'get_catalog_variants_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_catalog_variants_id
  ...
  # @return [Variant]
  describe 'put_catalog_variants_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
