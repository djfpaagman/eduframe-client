...
# Unit tests for Eduframe::PluginsEducatorPluginsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginsEducatorPluginsApi' do
  before do
    # run before each test
    @instance = Eduframe::PluginsEducatorPluginsApi.new
  end
  ...
  describe 'test an instance of PluginsEducatorPluginsApi' do
    it 'should create an instance of PluginsEducatorPluginsApi' do
      expect(@instance).to be_instance_of(Eduframe::PluginsEducatorPluginsApi)
    end
  end

  # unit tests for get_plugins_educators_id
  # Get all plugin installs by educator record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [EducatorPlugin]
  describe 'get_plugins_educators_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_plugins_educators
  # Install a plugin for a specific educator.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [EducatorPlugin]
  describe 'post_plugins_educators test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_plugins_educators_id
  ...
  # @option opts [Body] :body 
  # @return [EducatorPlugin]
  describe 'put_plugins_educators_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
