...
# Unit tests for Eduframe::AuthenticationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticationsApi' do
  before do
    # run before each test
    @instance = Eduframe::AuthenticationsApi.new
  end
  ...
  describe 'test an instance of AuthenticationsApi' do
    it 'should create an instance of AuthenticationsApi' do
      expect(@instance).to be_instance_of(Eduframe::AuthenticationsApi)
    end
  end

  # unit tests for post_authentications
  # Create an authentication.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Authentication]
  describe 'post_authentications test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_authentications_availability
  # Validate if the identifier is available for a new authentication
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_authentications_availability test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
