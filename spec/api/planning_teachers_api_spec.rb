...
# Unit tests for Eduframe::PlanningTeachersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningTeachersApi' do
  before do
    # run before each test
    @instance = Eduframe::PlanningTeachersApi.new
  end
  ...
  describe 'test an instance of PlanningTeachersApi' do
    it 'should create an instance of PlanningTeachersApi' do
      expect(@instance).to be_instance_of(Eduframe::PlanningTeachersApi)
    end
  end

  # unit tests for get_planning_teachers
  ...
  # @return [Array<User>]
  describe 'get_planning_teachers test' do
    it 'should work' do
