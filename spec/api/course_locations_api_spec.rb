...
# Unit tests for Eduframe::CourseLocationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseLocationsApi' do
  before do
    # run before each test
    @instance = Eduframe::CourseLocationsApi.new
  end
  ...
  describe 'test an instance of CourseLocationsApi' do
    it 'should create an instance of CourseLocationsApi' do
      expect(@instance).to be_instance_of(Eduframe::CourseLocationsApi)
    end
  end

  # unit tests for delete_course_locations_id
  # Delete a course location.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [CourseLocation]
  describe 'delete_course_locations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_course_locations
  ...
  describe 'get_course_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_course_locations_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [CourseLocation]
  describe 'get_course_locations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_course_locations
  # Create a course location.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [CourseLocation]
  describe 'post_course_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_course_locations_id
  ...
  # @option opts [Body] :body 
  # @return [CourseLocation]
  describe 'put_course_locations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
