...
# Unit tests for Eduframe::GraduationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GraduationsApi' do
  before do
    # run before each test
    @instance = Eduframe::GraduationsApi.new
  end
  ...
  describe 'test an instance of GraduationsApi' do
    it 'should create an instance of GraduationsApi' do
      expect(@instance).to be_instance_of(Eduframe::GraduationsApi)
    end
  end

  # unit tests for get_graduation_id
  # Get a graduation record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Graduation]
  describe 'get_graduation_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_graduation
  # Create a graduation
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Graduation]
  describe 'post_graduation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_graduation_id
  # Update a graduation
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Graduation]
  describe 'put_graduation_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
