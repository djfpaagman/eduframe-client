...
# Unit tests for Eduframe::MaterialsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaterialsApi' do
  before do
    # run before each test
    @instance = Eduframe::MaterialsApi.new
  end
  ...
  describe 'test an instance of MaterialsApi' do
    it 'should create an instance of MaterialsApi' do
      expect(@instance).to be_instance_of(Eduframe::MaterialsApi)
    end
  end

  # unit tests for delete_materials_id
  # Delete a material.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Material]
  describe 'delete_materials_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_materials
  ...
  describe 'get_materials test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_materials
  # Create a material.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Material]
  describe 'post_materials test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_materials_id
  # Update a material.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Material]
  describe 'put_materials_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
