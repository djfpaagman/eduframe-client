...
# Unit tests for Eduframe::WorkflowDispatchesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkflowDispatchesApi' do
  before do
    # run before each test
    @instance = Eduframe::WorkflowDispatchesApi.new
  end
  ...
  describe 'test an instance of WorkflowDispatchesApi' do
    it 'should create an instance of WorkflowDispatchesApi' do
      expect(@instance).to be_instance_of(Eduframe::WorkflowDispatchesApi)
    end
  end

  # unit tests for delete_workflow_dispatches_id
  # Delete a dispatch.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Dispatch]
  describe 'delete_workflow_dispatches_id test' do
    it 'should work' do
