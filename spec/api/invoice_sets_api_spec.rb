...
# Unit tests for Eduframe::InvoiceSetsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceSetsApi' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceSetsApi.new
  end
  ...
  describe 'test an instance of InvoiceSetsApi' do
    it 'should create an instance of InvoiceSetsApi' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceSetsApi)
    end
  end

  # unit tests for get_invoice_sets_id
  # Get an invoice set record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [InvoiceSet]
  describe 'get_invoice_sets_id test' do
    it 'should work' do
