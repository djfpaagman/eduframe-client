...
# Unit tests for Eduframe::TeachersAttendeesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeachersAttendeesApi' do
  before do
    # run before each test
    @instance = Eduframe::TeachersAttendeesApi.new
  end
  ...
  describe 'test an instance of TeachersAttendeesApi' do
    it 'should create an instance of TeachersAttendeesApi' do
      expect(@instance).to be_instance_of(Eduframe::TeachersAttendeesApi)
    end
  end

  # unit tests for get_planned_courses_planned_course_id_teacher_attendees
  ...
  describe 'get_planned_courses_planned_course_id_teacher_attendees test' do
    it 'should work' do
