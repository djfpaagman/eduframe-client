...
# Unit tests for Eduframe::SignupQuestionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignupQuestionsApi' do
  before do
    # run before each test
    @instance = Eduframe::SignupQuestionsApi.new
  end
  ...
  describe 'test an instance of SignupQuestionsApi' do
    it 'should create an instance of SignupQuestionsApi' do
      expect(@instance).to be_instance_of(Eduframe::SignupQuestionsApi)
    end
  end

  # unit tests for get_signup_questions
  ...
  describe 'get_signup_questions test' do
    it 'should work' do
