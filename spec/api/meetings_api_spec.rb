...
# Unit tests for Eduframe::MeetingsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingsApi' do
  before do
    # run before each test
    @instance = Eduframe::MeetingsApi.new
  end
  ...
  describe 'test an instance of MeetingsApi' do
    it 'should create an instance of MeetingsApi' do
      expect(@instance).to be_instance_of(Eduframe::MeetingsApi)
    end
  end

  # unit tests for deletemeetings_id
  # Delete a meeting.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Meeting]
  describe 'deletemeetings_id test' do
    it 'should work' do
  ...
  # unit tests for get_meetings_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Meeting]
  describe 'get_meetings_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planned_courses_planned_course_id_meetings
  ...
  # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
  # @return [Array<Meeting>]
  describe 'get_planned_courses_planned_course_id_meetings test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_meetings
  # Create a meeting.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Meeting]
  describe 'post_meetings test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_planned_courses_planned_course_id_meetings
  ...
  # @option opts [Body] :body 
  # @return [Meeting]
  describe 'post_planned_courses_planned_course_id_meetings test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_meetings_id
  # Update a meeting.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Meeting]
  describe 'put_meetings_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
