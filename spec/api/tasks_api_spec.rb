...
# Unit tests for Eduframe::TasksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TasksApi' do
  before do
    # run before each test
    @instance = Eduframe::TasksApi.new
  end
  ...
  describe 'test an instance of TasksApi' do
    it 'should create an instance of TasksApi' do
      expect(@instance).to be_instance_of(Eduframe::TasksApi)
    end
  end

  # unit tests for delete_tasks_id
  # Delete a task.
  # 
  # @param id 
  ...
  # @return [Task]
  describe 'delete_tasks_id test' do
    it 'should work' do
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Task]
  describe 'get_tasks_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_tasks
  # Create a task.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Task]
  describe 'post_tasks test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_tasks_id
  # Update a task.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
