...
# Unit tests for Eduframe::AccountsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountsApi' do
  before do
    # run before each test
    @instance = Eduframe::AccountsApi.new
  end
  ...
  describe 'test an instance of AccountsApi' do
    it 'should create an instance of AccountsApi' do
      expect(@instance).to be_instance_of(Eduframe::AccountsApi)
    end
  end
  ...
  # unit tests for get_accounts_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Account]
  describe 'get_accounts_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
