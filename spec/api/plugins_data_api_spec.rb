...
# Unit tests for Eduframe::PluginsDataApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginsDataApi' do
  before do
    # run before each test
    @instance = Eduframe::PluginsDataApi.new
  end
  ...
  describe 'test an instance of PluginsDataApi' do
    it 'should create an instance of PluginsDataApi' do
      expect(@instance).to be_instance_of(Eduframe::PluginsDataApi)
    end
  end

  # unit tests for delete_plugins_data_id
  # Delete this plugin data.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [PluginData]
  describe 'delete_plugins_data_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_plugins_data
  # Create one data field.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [PluginData]
  describe 'post_plugins_data test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_plugins_data_id
  ...
  # @option opts [Body] :body 
  # @return [PluginData]
  describe 'put_plugins_data_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
