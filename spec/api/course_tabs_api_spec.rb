...
# Unit tests for Eduframe::CourseTabsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseTabsApi' do
  before do
    # run before each test
    @instance = Eduframe::CourseTabsApi.new
  end
  ...
  describe 'test an instance of CourseTabsApi' do
    it 'should create an instance of CourseTabsApi' do
      expect(@instance).to be_instance_of(Eduframe::CourseTabsApi)
    end
  end

  # unit tests for get_course_tabs
  # Get all course tab records
  # 
  # @param [Hash] opts the optional parameters
  # @return [Array<CourseTab>]
  describe 'get_course_tabs test' do
    it 'should work' do
