...
# Unit tests for Eduframe::EducatorsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EducatorsApi' do
  before do
    # run before each test
    @instance = Eduframe::EducatorsApi.new
  end
  ...
  describe 'test an instance of EducatorsApi' do
    it 'should create an instance of EducatorsApi' do
      expect(@instance).to be_instance_of(Eduframe::EducatorsApi)
    end
  end

  # unit tests for get_educators_current
  # Get an educator record
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Array<String>] :include Include relations
  # @return [Educator]
  describe 'get_educators_current test' do
    it 'should work' do
