...
# Unit tests for Eduframe::InvoiceItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceItemsApi' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceItemsApi.new
  end
  ...
  describe 'test an instance of InvoiceItemsApi' do
    it 'should create an instance of InvoiceItemsApi' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceItemsApi)
    end
  end

  # unit tests for get_invoices_invoice_id_invoice_items
  ...
  describe 'get_invoices_invoice_id_invoice_items test' do
    it 'should work' do
