...
# Unit tests for Eduframe::MergeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MergeApi' do
  before do
    # run before each test
    @instance = Eduframe::MergeApi.new
  end
  ...
  describe 'test an instance of MergeApi' do
    it 'should create an instance of MergeApi' do
      expect(@instance).to be_instance_of(Eduframe::MergeApi)
    end
  end

  # unit tests for post_merge_users
  # Merge two users. Conditions apply.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Merge]
  describe 'post_merge_users test' do
    it 'should work' do
