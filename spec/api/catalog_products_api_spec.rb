...
# Unit tests for Eduframe::CatalogProductsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogProductsApi' do
  before do
    # run before each test
    @instance = Eduframe::CatalogProductsApi.new
  end
  ...
  describe 'test an instance of CatalogProductsApi' do
    it 'should create an instance of CatalogProductsApi' do
      expect(@instance).to be_instance_of(Eduframe::CatalogProductsApi)
    end
  end

  # unit tests for get_catalog_products
  ...
  describe 'get_catalog_products test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_catalog_products_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Product]
  describe 'get_catalog_products_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_catalog_products_sort
  # Sort the elements (set positions).
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_catalog_products_sort test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_catalog_products_id
  ...
  # @option opts [Body] :body 
  # @return [Product]
  describe 'put_catalog_products_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
