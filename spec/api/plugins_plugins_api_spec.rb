...
# Unit tests for Eduframe::PluginsPluginsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginsPluginsApi' do
  before do
    # run before each test
    @instance = Eduframe::PluginsPluginsApi.new
  end
  ...
  describe 'test an instance of PluginsPluginsApi' do
    it 'should create an instance of PluginsPluginsApi' do
      expect(@instance).to be_instance_of(Eduframe::PluginsPluginsApi)
    end
  end

  # unit tests for get_plugins_plugins_id
  # Get a plugin record (id must be current)
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Plugin]
  describe 'get_plugins_plugins_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_plugins_plugins
  # Create a plugin.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Plugin]
  describe 'post_plugins_plugins test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
