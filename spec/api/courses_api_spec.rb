...
# Unit tests for Eduframe::CoursesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoursesApi' do
  before do
    # run before each test
    @instance = Eduframe::CoursesApi.new
  end
  ...
  describe 'test an instance of CoursesApi' do
    it 'should create an instance of CoursesApi' do
      expect(@instance).to be_instance_of(Eduframe::CoursesApi)
    end
  end
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Course]
  describe 'get_courses_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_courses
  # Create a course.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Course]
  describe 'post_courses test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_courses_id
  # Update a course.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Course]
  describe 'put_courses_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
