...
# Unit tests for Eduframe::CertificateTemplatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CertificateTemplatesApi' do
  before do
    # run before each test
    @instance = Eduframe::CertificateTemplatesApi.new
  end
  ...
  describe 'test an instance of CertificateTemplatesApi' do
    it 'should create an instance of CertificateTemplatesApi' do
      expect(@instance).to be_instance_of(Eduframe::CertificateTemplatesApi)
    end
  end

  # unit tests for delete_certificate_templates_id
  # Delete a certificate template
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [CerfiticateTemplate]
  describe 'delete_certificate_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_certificate_templates
  ...
  describe 'get_certificate_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_certificate_templates_id_duplicate
  # Duplicate a certificate template
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [CerfiticateTemplate]
  describe 'put_certificate_templates_id_duplicate test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
