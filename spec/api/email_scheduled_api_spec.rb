...
# Unit tests for Eduframe::EmailScheduledApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailScheduledApi' do
  before do
    # run before each test
    @instance = Eduframe::EmailScheduledApi.new
  end
  ...
  describe 'test an instance of EmailScheduledApi' do
    it 'should create an instance of EmailScheduledApi' do
      expect(@instance).to be_instance_of(Eduframe::EmailScheduledApi)
    end
  end

  # unit tests for delete_email_scheduled_id
  # Delete a scheduled email.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [ScheduledEmail]
  describe 'delete_email_scheduled_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_email_scheduled_id_deliver
  # Deliver a scheduled email.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [ScheduledEmail]
  describe 'put_email_scheduled_id_deliver test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
