...
# Unit tests for Eduframe::EnrollmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EnrollmentsApi' do
  before do
    # run before each test
    @instance = Eduframe::EnrollmentsApi.new
  end
  ...
  describe 'test an instance of EnrollmentsApi' do
    it 'should create an instance of EnrollmentsApi' do
      expect(@instance).to be_instance_of(Eduframe::EnrollmentsApi)
    end
  end
  ...
  # unit tests for get_enrollments_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Enrollment]
  describe 'get_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_students_student_id_enrollments
  ...
  # @option opts [Array<String>] :status Filter results on status
  # @return [Array<Enrollment>]
  describe 'get_students_student_id_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_students_student_id_enrollments_id
  # Get an enrollment record
  # 
  # @param id 
  # @param student_id 
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Enrollment]
  describe 'get_students_student_id_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_award_certificates_batch
  # Award certificates to enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_award_certificates_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_award_credits_batch
  # Award credits to enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_award_credits_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_cancel_batch
  # Cancel enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_cancel_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_fail_batch
  # Fail enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_fail_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_id
  ...
  # @option opts [Body] :body 
  # @return [Enrollment]
  describe 'put_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_id_cancel
  ...
  # @option opts [Body] :body 
  # @return [Enrollment]
  describe 'put_enrollments_id_cancel test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_pass_batch
  # Pass enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_pass_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_enrollments_revoke_graduation_batch
  # Revoke graduation enrollments in batch
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<Enrollment>]
  describe 'put_enrollments_revoke_graduation_batch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
