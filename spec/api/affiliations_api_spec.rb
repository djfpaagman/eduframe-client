...
# Unit tests for Eduframe::AffiliationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AffiliationsApi' do
  before do
    # run before each test
    @instance = Eduframe::AffiliationsApi.new
  end
  ...
  describe 'test an instance of AffiliationsApi' do
    it 'should create an instance of AffiliationsApi' do
      expect(@instance).to be_instance_of(Eduframe::AffiliationsApi)
    end
  end

  # unit tests for delete_affiliations_id
  # Delete an affiliation
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Affiliation]
  describe 'delete_affiliations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_affiliations
  ...
  describe 'get_affiliations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_affiliations
  # Create an affiliation affiliations
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Affiliation]
  describe 'post_affiliations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_affiliations_id
  ...
  # @option opts [Body] :body 
  # @return [Affiliation]
  describe 'put_affiliations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
