...
# Unit tests for Eduframe::PlanningEventTemplatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningEventTemplatesApi' do
  before do
    # run before each test
    @instance = Eduframe::PlanningEventTemplatesApi.new
  end
  ...
  describe 'test an instance of PlanningEventTemplatesApi' do
    it 'should create an instance of PlanningEventTemplatesApi' do
      expect(@instance).to be_instance_of(Eduframe::PlanningEventTemplatesApi)
    end
  end

  # unit tests for delete_planning_events_templates_id
  # Delete a planning event template.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [PlanningEventTemplate]
  describe 'delete_planning_events_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planning_event_templates
  ...
  describe 'get_planning_event_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_planning_event_templates_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [PlanningEventTemplate]
  describe 'get_planning_event_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_planning_events_templates_id
  ...
  # @return [PlanningEventTemplate]
  describe 'post_planning_events_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_planning_events_templates_id
  ...
  # @option opts [Body] :body 
  # @return [PlanningEventTemplate]
  describe 'put_planning_events_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
