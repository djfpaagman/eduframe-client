...
# Unit tests for Eduframe::CommentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommentsApi' do
  before do
    # run before each test
    @instance = Eduframe::CommentsApi.new
  end
  ...
  describe 'test an instance of CommentsApi' do
    it 'should create an instance of CommentsApi' do
      expect(@instance).to be_instance_of(Eduframe::CommentsApi)
    end
  end

  # unit tests for delete_comments_id
  # Delete a comment.
  # 
  # @param id 
  ...
  # @return [Comment]
  describe 'delete_comments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_comments
  # Create a comment.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Comment]
  describe 'post_comments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_comments_id
  # Update a comment.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Comment]
  describe 'put_comments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
