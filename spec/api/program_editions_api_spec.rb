...
# Unit tests for Eduframe::ProgramEditionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramEditionsApi' do
  before do
    # run before each test
    @instance = Eduframe::ProgramEditionsApi.new
  end
  ...
  describe 'test an instance of ProgramEditionsApi' do
    it 'should create an instance of ProgramEditionsApi' do
      expect(@instance).to be_instance_of(Eduframe::ProgramEditionsApi)
    end
  end

  # unit tests for delete_program_editions_id
  # Delete a program edition
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Edition]
  describe 'delete_program_editions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_editions
  ...
  describe 'get_program_editions test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_editions_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Edition]
  describe 'get_program_editions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_program_editions
  # Create a program edition
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Edition]
  describe 'post_program_editions test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_program_editions_id
  ...
  # @option opts [Body] :body 
  # @return [Edition]
  describe 'put_program_editions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
