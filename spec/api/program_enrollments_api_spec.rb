...
# Unit tests for Eduframe::ProgramEnrollmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramEnrollmentsApi' do
  before do
    # run before each test
    @instance = Eduframe::ProgramEnrollmentsApi.new
  end
  ...
  describe 'test an instance of ProgramEnrollmentsApi' do
    it 'should create an instance of ProgramEnrollmentsApi' do
      expect(@instance).to be_instance_of(Eduframe::ProgramEnrollmentsApi)
    end
  end

  # unit tests for get_program_enrollments
  ...
  describe 'get_program_enrollments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_enrollments_id
  ...
  describe 'get_program_enrollments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_program_enrollments_id_cancel
  ...
  # @return [ProgramEnrollment]
  describe 'put_program_enrollments_id_cancel test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
