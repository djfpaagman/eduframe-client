...
# Unit tests for Eduframe::WebhooksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhooksApi' do
  before do
    # run before each test
    @instance = Eduframe::WebhooksApi.new
  end
  ...
  describe 'test an instance of WebhooksApi' do
    it 'should create an instance of WebhooksApi' do
      expect(@instance).to be_instance_of(Eduframe::WebhooksApi)
    end
  end

  # unit tests for delete_webhooks_id
  # Delete a webhook.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Webhook]
  describe 'delete_webhooks_id test' do
    it 'should work' do
  ...
  # unit tests for get_webhooks_id
  # Get a registered webhook
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Webhook]
  describe 'get_webhooks_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
