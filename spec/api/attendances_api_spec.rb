...
# Unit tests for Eduframe::AttendancesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AttendancesApi' do
  before do
    # run before each test
    @instance = Eduframe::AttendancesApi.new
  end
  ...
  describe 'test an instance of AttendancesApi' do
    it 'should create an instance of AttendancesApi' do
      expect(@instance).to be_instance_of(Eduframe::AttendancesApi)
    end
  end
  ...
  # unit tests for put_attendances_id
  ...
  # @return [Attendance]
  describe 'put_attendances_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
