...
# Unit tests for Eduframe::CategoriesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CategoriesApi' do
  before do
    # run before each test
    @instance = Eduframe::CategoriesApi.new
  end
  ...
  describe 'test an instance of CategoriesApi' do
    it 'should create an instance of CategoriesApi' do
      expect(@instance).to be_instance_of(Eduframe::CategoriesApi)
    end
  end
  ...
  # unit tests for get_categories_id
  # Get a category record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Category]
  describe 'get_categories_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for post_categories_sort
  # Sort the categories (set positions).
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_categories_sort test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_categories_id
  # Update a category.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Category]
  describe 'put_categories_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
