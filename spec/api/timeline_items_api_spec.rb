...
# Unit tests for Eduframe::TimelineItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineItemsApi' do
  before do
    # run before each test
    @instance = Eduframe::TimelineItemsApi.new
  end
  ...
  describe 'test an instance of TimelineItemsApi' do
    it 'should create an instance of TimelineItemsApi' do
      expect(@instance).to be_instance_of(Eduframe::TimelineItemsApi)
    end
  end

  # unit tests for get_timeline_items
  ...
  describe 'get_timeline_items test' do
    it 'should work' do
