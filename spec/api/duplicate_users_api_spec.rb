...
# Unit tests for Eduframe::DuplicateUsersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DuplicateUsersApi' do
  before do
    # run before each test
    @instance = Eduframe::DuplicateUsersApi.new
  end
  ...
  describe 'test an instance of DuplicateUsersApi' do
    it 'should create an instance of DuplicateUsersApi' do
      expect(@instance).to be_instance_of(Eduframe::DuplicateUsersApi)
    end
  end

  # unit tests for get_duplicate_users
  # Get duplicate users
  # 
  ...
  describe 'get_duplicate_users test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_duplicate_users_id
  ...
  describe 'put_duplicate_users_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
