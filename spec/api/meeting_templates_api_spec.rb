...
# Unit tests for Eduframe::MeetingTemplatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingTemplatesApi' do
  before do
    # run before each test
    @instance = Eduframe::MeetingTemplatesApi.new
  end
  ...
  describe 'test an instance of MeetingTemplatesApi' do
    it 'should create an instance of MeetingTemplatesApi' do
      expect(@instance).to be_instance_of(Eduframe::MeetingTemplatesApi)
    end
  end

  # unit tests for delete_meeting_templates_id
  ...
  describe 'delete_meeting_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_meeting_templates
  ...
  describe 'get_meeting_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_meeting_templates_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [MeetingTemplate]
  describe 'get_meeting_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_meeting_templates
  # Create a meeting template.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [MeetingTemplate]
  describe 'post_meeting_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_meeting_templates_id
  ...
  # @option opts [Body] :body 
  # @return [MeetingTemplate]
  describe 'put_meeting_templates_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
