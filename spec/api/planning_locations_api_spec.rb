...
# Unit tests for Eduframe::PlanningLocationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanningLocationsApi' do
  before do
    # run before each test
    @instance = Eduframe::PlanningLocationsApi.new
  end
  ...
  describe 'test an instance of PlanningLocationsApi' do
    it 'should create an instance of PlanningLocationsApi' do
      expect(@instance).to be_instance_of(Eduframe::PlanningLocationsApi)
    end
  end

  # unit tests for get_planning_locations
  ...
  describe 'get_planning_locations test' do
    it 'should work' do
