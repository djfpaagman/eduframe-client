...
# Unit tests for Eduframe::InvoiceVatsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceVatsApi' do
  before do
    # run before each test
    @instance = Eduframe::InvoiceVatsApi.new
  end
  ...
  describe 'test an instance of InvoiceVatsApi' do
    it 'should create an instance of InvoiceVatsApi' do
      expect(@instance).to be_instance_of(Eduframe::InvoiceVatsApi)
    end
  end

  # unit tests for get_invoice_vats
  # Get all invoice vat records
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Array<String>] :include Include relations
  # @return [Array<InvoiceVat>]
  describe 'get_invoice_vats test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_invoice_vats
  # Create an invoice vat.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [InvoiceVat]
  describe 'post_invoice_vats test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
