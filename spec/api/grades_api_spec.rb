...
# Unit tests for Eduframe::GradesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GradesApi' do
  before do
    # run before each test
    @instance = Eduframe::GradesApi.new
  end
  ...
  describe 'test an instance of GradesApi' do
    it 'should create an instance of GradesApi' do
      expect(@instance).to be_instance_of(Eduframe::GradesApi)
    end
  end

  # unit tests for get_grades_id
  # Get a grade record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Grade]
  describe 'get_grades_id test' do
    it 'should work' do
  ...
  # @option opts [Body] :body 
  # @return [Grade]
  describe 'put_grades_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
