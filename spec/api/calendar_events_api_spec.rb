...
# Unit tests for Eduframe::CalendarEventsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CalendarEventsApi' do
  before do
    # run before each test
    @instance = Eduframe::CalendarEventsApi.new
  end
  ...
  describe 'test an instance of CalendarEventsApi' do
    it 'should create an instance of CalendarEventsApi' do
      expect(@instance).to be_instance_of(Eduframe::CalendarEventsApi)
    end
  end
  ...
  describe 'get_calendar_events test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_calendar_events_id
  # Get an event record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_calendar_events_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_calendar_events
  # Create a calendar event
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [CalendarEvent]
  describe 'post_calendar_events test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
