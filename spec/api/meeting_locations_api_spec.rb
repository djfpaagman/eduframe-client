...
# Unit tests for Eduframe::MeetingLocationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingLocationsApi' do
  before do
    # run before each test
    @instance = Eduframe::MeetingLocationsApi.new
  end
  ...
  describe 'test an instance of MeetingLocationsApi' do
    it 'should create an instance of MeetingLocationsApi' do
      expect(@instance).to be_instance_of(Eduframe::MeetingLocationsApi)
    end
  end

  # unit tests for delete_meeting_locations_id
  # Delete a course location.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [MeetingLocation]
  describe 'delete_meeting_locations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_course_locations_course_location_id_meeting_locations
  ...
  describe 'get_course_locations_course_location_id_meeting_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_meeting_locations
  ...
  # @option opts [Array<String>] :sort Sort the results. Can change order by using &#x60;&lt;sort_by&gt;:&lt;direction&gt;&#x60; where &#x60;&lt;direction&gt;&#x60; is either &#x60;asc&#x60; or &#x60;desc&#x60;
  # @return [Array<MeetingLocation>]
  describe 'get_meeting_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_course_locations_course_location_id_meeting_locations
  ...
  # @return [MeetingLocation]
  describe 'post_course_locations_course_location_id_meeting_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_meeting_locations
  # Create a meeting location.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [MeetingLocation]
  describe 'post_meeting_locations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_meeting_locations_id
  ...
  # @option opts [Body] :body 
  # @return [MeetingLocation]
  describe 'put_meeting_locations_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
