...
# Unit tests for Eduframe::LabelsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelsApi' do
  before do
    # run before each test
    @instance = Eduframe::LabelsApi.new
  end
  ...
  describe 'test an instance of LabelsApi' do
    it 'should create an instance of LabelsApi' do
      expect(@instance).to be_instance_of(Eduframe::LabelsApi)
    end
  end
  ...
  # unit tests for get_labels_id
  # Get a label record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Label]
  describe 'get_labels_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
