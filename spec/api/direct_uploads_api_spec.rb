...
# Unit tests for Eduframe::DirectUploadsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectUploadsApi' do
  before do
    # run before each test
    @instance = Eduframe::DirectUploadsApi.new
  end
  ...
  describe 'test an instance of DirectUploadsApi' do
    it 'should create an instance of DirectUploadsApi' do
      expect(@instance).to be_instance_of(Eduframe::DirectUploadsApi)
    end
  end

  # unit tests for post_direct_uploads
  # Creates a new blob on the server side in anticipation of a direct-to-service.
  # 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'post_direct_uploads test' do
    it 'should work' do
