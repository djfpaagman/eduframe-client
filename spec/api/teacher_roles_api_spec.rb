...
# Unit tests for Eduframe::TeacherRolesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeacherRolesApi' do
  before do
    # run before each test
    @instance = Eduframe::TeacherRolesApi.new
  end
  ...
  describe 'test an instance of TeacherRolesApi' do
    it 'should create an instance of TeacherRolesApi' do
      expect(@instance).to be_instance_of(Eduframe::TeacherRolesApi)
    end
  end

  # unit tests for delete_teacher_roles_id
  # Delete a teacher role.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [TeacherRole]
  describe 'delete_teacher_roles_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_teacher_roles
  ...
  describe 'get_teacher_roles test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_teacher_roles_id
  # Get a teacher role
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [TeacherRole]
  describe 'get_teacher_roles_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_teacher_roles
  # Create a teacher role.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [TeacherRole]
  describe 'post_teacher_roles test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_teacher_roles_id
  ...
  # @option opts [Body] :body 
  # @return [TeacherRole]
  describe 'put_teacher_roles_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
