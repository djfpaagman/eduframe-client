...
# Unit tests for Eduframe::ProgramElementsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramElementsApi' do
  before do
    # run before each test
    @instance = Eduframe::ProgramElementsApi.new
  end
  ...
  describe 'test an instance of ProgramElementsApi' do
    it 'should create an instance of ProgramElementsApi' do
      expect(@instance).to be_instance_of(Eduframe::ProgramElementsApi)
    end
  end

  # unit tests for delete_program_elements_id
  # Delete a element
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Element]
  describe 'delete_program_elements_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_elements
  # Get all elements
  # 
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_program_elements test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_program_elements
  # Create a program element
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Element]
  describe 'post_program_elements test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_program_elements_sort
  # Sort the elements (set positions).
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_program_elements_sort test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_program_elements_id
  # Update an element
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Element]
  describe 'put_program_elements_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
