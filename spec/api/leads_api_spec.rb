...
# Unit tests for Eduframe::LeadsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeadsApi' do
  before do
    # run before each test
    @instance = Eduframe::LeadsApi.new
  end
  ...
  describe 'test an instance of LeadsApi' do
    it 'should create an instance of LeadsApi' do
      expect(@instance).to be_instance_of(Eduframe::LeadsApi)
    end
  end

  # unit tests for delete_leads_id
  # Delete a lead.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Lead]
  describe 'delete_leads_id test' do
    it 'should work' do
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Lead]
  describe 'get_leads_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_leads
  # Create a lead.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_leads test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_leads_id
  # Update an lead.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
