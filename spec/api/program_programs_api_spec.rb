...
# Unit tests for Eduframe::ProgramProgramsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramProgramsApi' do
  before do
    # run before each test
    @instance = Eduframe::ProgramProgramsApi.new
  end
  ...
  describe 'test an instance of ProgramProgramsApi' do
    it 'should create an instance of ProgramProgramsApi' do
      expect(@instance).to be_instance_of(Eduframe::ProgramProgramsApi)
    end
  end

  # unit tests for delete_program_programs_id
  # Delete a program
  # 
  # @param id 
  ...
  # @return [Program]
  describe 'delete_program_programs_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_programs
  # Get all programs
  # 
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_program_programs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_program_programs_id
  # Get a program
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Array<String>] :include Include relations
  # @return [Program]
  describe 'get_program_programs_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_program_programs
  # Create a program
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Program]
  describe 'post_program_programs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_program_programs_id
  # Update a program
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Program]
  describe 'put_program_programs_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
