...
# Unit tests for Eduframe::PaymentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentsApi' do
  before do
    # run before each test
    @instance = Eduframe::PaymentsApi.new
  end
  ...
  describe 'test an instance of PaymentsApi' do
    it 'should create an instance of PaymentsApi' do
      expect(@instance).to be_instance_of(Eduframe::PaymentsApi)
    end
  end

  # unit tests for delete_invoices_invoice_id_payments_id
  # Delete a payment.
  # 
  # @param id 
  # @param invoice_id 
  ...
  # @return [Payment]
  describe 'delete_invoices_invoice_id_payments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_invoices_invoice_id_payments
  ...
  describe 'get_invoices_invoice_id_payments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_payments_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Payment]
  describe 'get_payments_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_invoices_invoice_id_payments
  # Create a payment.
  # 
  # @param invoice_id 
  # @param [Hash] opts the optional parameters
  ...
  # @return [Payment]
  describe 'post_invoices_invoice_id_payments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
