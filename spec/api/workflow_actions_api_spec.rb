...
# Unit tests for Eduframe::WorkflowActionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkflowActionsApi' do
  before do
    # run before each test
    @instance = Eduframe::WorkflowActionsApi.new
  end
  ...
  describe 'test an instance of WorkflowActionsApi' do
    it 'should create an instance of WorkflowActionsApi' do
      expect(@instance).to be_instance_of(Eduframe::WorkflowActionsApi)
    end
  end

  # unit tests for delete_workflow_actions_id
  # Delete an action.
  # 
  # @param id 
  ...
  describe 'delete_workflow_actions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workflow_actions
  ...
  describe 'get_workflow_actions test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workflow_actions_id
  # Get a action record
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Array<String>] :include Include relations
  # @return [WorkflowAction]
  describe 'get_workflow_actions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_workflow_actions
  # Create an action.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [WorkflowAction]
  describe 'post_workflow_actions test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_workflow_actions_id
  # Update an action.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [WorkflowAction]
  describe 'put_workflow_actions_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
