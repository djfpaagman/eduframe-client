...
# Unit tests for Eduframe::CalendarItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CalendarItemsApi' do
  before do
    # run before each test
    @instance = Eduframe::CalendarItemsApi.new
  end
  ...
  describe 'test an instance of CalendarItemsApi' do
    it 'should create an instance of CalendarItemsApi' do
      expect(@instance).to be_instance_of(Eduframe::CalendarItemsApi)
    end
  end

  # unit tests for get_calendar_items_resources_type
  ...
  describe 'get_calendar_items_resources_type test' do
    it 'should work' do
