...
# Unit tests for Eduframe::InvoicesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesApi' do
  before do
    # run before each test
    @instance = Eduframe::InvoicesApi.new
  end
  ...
  describe 'test an instance of InvoicesApi' do
    it 'should create an instance of InvoicesApi' do
      expect(@instance).to be_instance_of(Eduframe::InvoicesApi)
    end
  end
  ...
  # unit tests for get_invoices_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [Invoice]
  describe 'get_invoices_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_invoices_id_pdf
  # Get the base64 encoded version of the invoice PDF
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'get_invoices_id_pdf test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for post_invoices_id_open
  ...
  # @option opts [Body] :body 
  # @return [Invoice]
  describe 'post_invoices_id_open test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
