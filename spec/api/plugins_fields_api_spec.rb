...
# Unit tests for Eduframe::PluginsFieldsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PluginsFieldsApi' do
  before do
    # run before each test
    @instance = Eduframe::PluginsFieldsApi.new
  end
  ...
  describe 'test an instance of PluginsFieldsApi' do
    it 'should create an instance of PluginsFieldsApi' do
      expect(@instance).to be_instance_of(Eduframe::PluginsFieldsApi)
    end
  end

  # unit tests for post_plugins_fields
  # Create a field.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [PluginField]
  describe 'post_plugins_fields test' do
    it 'should work' do
