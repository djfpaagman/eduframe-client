...
# Unit tests for Eduframe::MaterialGroupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaterialGroupsApi' do
  before do
    # run before each test
    @instance = Eduframe::MaterialGroupsApi.new
  end
  ...
  describe 'test an instance of MaterialGroupsApi' do
    it 'should create an instance of MaterialGroupsApi' do
      expect(@instance).to be_instance_of(Eduframe::MaterialGroupsApi)
    end
  end

  # unit tests for delete_material_groups_id
  # Delete a material group.
  # 
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [MaterialGroup]
  describe 'delete_material_groups_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_material_groups
  ...
  describe 'get_material_groups test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_material_groups_id
  ...
  # @option opts [Array<String>] :include Include relations
  # @return [MaterialGroup]
  describe 'get_material_groups_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_material_groups
  # Create a material group.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [MaterialGroup]
  describe 'post_material_groups test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_material_groups_id
  ...
  # @option opts [Body] :body 
  # @return [MaterialGroup]
  describe 'put_material_groups_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
