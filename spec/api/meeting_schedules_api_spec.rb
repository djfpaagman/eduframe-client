...
# Unit tests for Eduframe::MeetingSchedulesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingSchedulesApi' do
  before do
    # run before each test
    @instance = Eduframe::MeetingSchedulesApi.new
  end
  ...
  describe 'test an instance of MeetingSchedulesApi' do
    it 'should create an instance of MeetingSchedulesApi' do
      expect(@instance).to be_instance_of(Eduframe::MeetingSchedulesApi)
    end
  end

  # unit tests for post_meeting_schedules
  # Create recurring meetings
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Array<MeetingSchedule>]
  describe 'post_meeting_schedules test' do
    it 'should work' do
