...
# Unit tests for Eduframe::PasswordResetsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PasswordResetsApi' do
  before do
    # run before each test
    @instance = Eduframe::PasswordResetsApi.new
  end
  ...
  describe 'test an instance of PasswordResetsApi' do
    it 'should create an instance of PasswordResetsApi' do
      expect(@instance).to be_instance_of(Eduframe::PasswordResetsApi)
    end
  end

  # unit tests for post_password_resets
  # Create a password reset.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Body] :body 
  # @return [Error]
  describe 'post_password_resets test' do
    it 'should work' do
